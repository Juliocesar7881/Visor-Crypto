// ============================================
        ...
        // Cache sistema para anÃ¡lise tÃ©cnica
        ...
        function setTACache(symbol, data) {
            try {
                ...
                // localStorage quota exceeded â clear old TA caches
                try {
                    const keysToRemove = [];
        ...
        // CALL HISTORY SYSTEM â HistÃ³rico real de calls
        // Ã¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢Â
        ...
        function recordCall(symbol, signal, confidence, entryPrice, crypto, fullAnalysis) {
            ...
            // Don't duplicate â skip if same symbol+direction within 30 min
            ...
            // Extrair snapshot completo da anÃ¡lise para banco de dados
            const analytics = {};
            if (fullAnalysis) {
                try {
                ...
                <div style="background:linear-gradient(180deg,#1c1c35 0%,#141423 100%);border:1px solid rgba(245,158,11,0.3);border-radius:24px 24px 0 0;max-width:480px;width:100%;padding:24px 22px 36px;max-height:88vh;overflow-y:auto;box-shadow:0 -8px 40px rgba(0,0,0,0.5);animation:slideUpCard 0.3s cubic-bezier(0.22,1,0.36,1) forwards;">
                    ...
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
                        <div style="display:flex;align-items:center;gap:10px;">
                            <div style="width:36px;height:36px;background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.35);border-radius:10px;display:inline-flex;align-items:center;justify-content:center;">
                                <span style="font-size:18px;">Ã¢Å¡Â Ã¯Â¸Â</span>
                            </div>
                    ...
                    <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:16px;">
                        <div style="display:flex;align-items:flex-start;gap:10px;padding:10px 12px;background:rgba(245,158,11,0.07);border:1px solid rgba(245,158,11,0.18);border-radius:11px;">
                            <span style="color:#f59e0b;font-size:14px;flex-shrink:0;margin-top:1px;">Ã°Å¸ââ¹</span>
                            <span style="font-size:12px;color:#c9d1d9;line-height:1.6;"><strong style="color:#f59e0b;">Informativo e educacional.</strong> NÃ£o constitui aconselhamento financeiro, recomendaÃ§Ã£o de investimento ou solicitaÃ§Ã£o de compra/venda de ativos.</span>
                        </div>
                        <div style="display:flex;align-items:flex-start;gap:10px;padding:10px 12px;background:rgba(239,68,68,0.07);border:1px solid rgba(239,68,68,0.18);border-radius:11px;">
                            <span style="color:#ef4444;font-size:14px;flex-shrink:0;margin-top:1px;">Ã¢Å¡Â¡</span>
                            <span style="font-size:12px;color:#c9d1d9;line-height:1.6;">Criptomoedas envolvem <strong style="color:#ef4444;">alto risco de perda total</strong> do capital. O mercado Ã© extremamente volÃ¡til e imprevisÃ­vel.</span>
                        </div>
                        <div style="display:flex;align-items:flex-start;gap:10px;padding:10px 12px;background:rgba(99,102,241,0.07);border:1px solid rgba(99,102,241,0.18);border-radius:11px;">
                            <span style="color:#a78bfa;font-size:14px;flex-shrink:0;margin-top:1px;">Ã°Å¸Â¤â</span>
                            <span style="font-size:12px;color:#c9d1d9;line-height:1.6;">AnÃ¡lises geradas por algoritmos, podendo conter erros. Resultados passados <strong style="color:#a78bfa;">nÃ£o garantem</strong> resultados futuros.</span>
                        </div>
                        <div style="display:flex;align-items:flex-start;gap:10px;padding:10px 12px;background:rgba(88,166,255,0.07);border:1px solid rgba(88,166,255,0.18);border-radius:11px;">
                            <span style="color:#58a6ff;font-size:14px;flex-shrink:0;margin-top:1px;">Ã°Å¸âÂ</span>
                            <span style="font-size:12px;color:#c9d1d9;line-height:1.6;">FaÃ§a sua prÃ³pria pesquisa (<strong style="color:#58a6ff;">DYOR</strong>) e consulte um profissional financeiro antes de investir.</span>
                        </div>
                    </div>
                    <p style="font-size:10px;color:#6e7681;line-height:1.6;text-align:center;margin-bottom:16px;">Todas as decisÃµes de investimento sÃ£o de sua exclusiva responsabilidade. Os desenvolvedores nÃ£o se responsabilizam por perdas financeiras.</p>
                    <div style="display:flex;align-items:center;justify-content:space-between;">
                        <a href="privacy-policy.html" target="_blank" style="color:#58a6ff;font-size:10px;text-decoration:underline;">PolÃ­tica de Privacidade</a>
                        <button id="aviso-ok-btn" style="padding:11px 28px;background:rgba(245,158,11,0.15);border:1.5px solid rgba(245,158,11,0.45);border-radius:12px;color:#f59e0b;font-weight:700;font-size:12px;cursor:pointer;touch-action:manipulation;-webkit-tap-highlight-color:transparent;">Entendi â</button>
                    </div>
                </div>
            `;
        ...
        function closeTechnicalAnalysis() {
            // Fechar panel de notificaÃ§Ãµes se aberto
            ...
            document.body.style.overflow = 'hidden'; // Manter scroll bloqueado para o modal do grÃ¡fico
            
            // Voltar para o modal do grÃ¡fico
            taNavigationStack.pop();
        }
        
        // VariÃ¡vel para controlar o auto-refresh da anÃ¡lise tÃ©cnica
                        ...
                        try {
                            ...
                            if (v4Enhanced.v4Signal) {
                                ...
                                if (v4Enhanced.reactiveSummary) {
                                    analysis.aiSummary += '\n\nÃ¢âÂÃ¢âÂÃ¢âÂ ANÃLISE AVANÃâ¡ADA Ã¢âÂÃ¢âÂÃ¢âÂ\n' + v4Enhanced.reactiveSummary;
                                }
                            }
...
let _taRawDataCache = {};
        ...
        async function fetchTechnicalAnalysisData(symbol) {
            ...
            // V7: Otimizado â restaurado 5m para modelagem de scalp (Pine v7), mantidos 15m, 1h, 4h, 1d
            const [
                klines5m,
                klines15m,
                klines1h,
                ...
                fetch(`https://fapi.binance.com/fapi/v1/openInterest?symbol=${symbol}`)
                    .then(r => r.json()).catch(() => ({})),
                // Recent trades para CVD (500 Ãºltimos)
                ...
                fetch(`https://fapi.binance.com/futures/data/takerlongshortRatio?symbol=${symbol}&period=1h&limit=24`)
                    .then(r => r.json()).catch(() => []),
                // LIQUIDAÃâ¡Ãâ¢ES FORÃâ¡ADAS REAIS (Ãºltimas 100) - DADOS REAIS DA BINANCE
                fetch(`https://fapi.binance.com/fapi/v1/allForceOrders?symbol=${symbol}&limit=100`)
                    .then(r => r.json()).catch(() => []),
                // Open Interest HistÃ³rico (Ãºltimos 12 perÃ­odos de 5min) - para OI Delta
                fetch(`https://fapi.binance.com/futures/data/openInterestHist?symbol=${symbol}&period=5m&limit=12`)
                    .then(r => r.json()).catch(() => []),
                // LiquidaÃ§Ãµes 12h do worker (em paralelo, timeout 3s)
            ...
            const result = {
                ...
                forceOrders: forceOrders || [],  // LIQUIDAÃâ¡Ãâ¢ES REAIS
                openInterestHist: openInterestHist || [],  // OI Delta
                workerLiqData,  // LiquidaÃ§Ãµes 12h do worker (ou null)
        ...
        function evaluatePineV7Model(klines5m, klines15m, currentPrice) {
            ...
            // Blended Score (Pesos: 60% para 5m porque o foco Ã© scalp e timing, 40% para 15m)
            ...
            // Se 5m e 15m cravarem compra = FORTE BUY. Se sÃ³ o 5m der compra e o score geral for bom = SCALP BUY
            ...
            if (active) {
                if (score >= 90) {
                    ...
                    confidenceBoost = 15; // ReforÃ§ado para scalp
                } else {
        ...
        function generateTechnicalAnalysis(data, symbol) {
            ...
            // Sistema de confluÃªncia profissional com pesos
            // ============================================
            
            // RSI em mÃºltiplos timeframes (peso: 2 cada)
            ...
            // ============================================
            // ANÃLISE GRÃFICA MULTI-TIMEFRAME (1m, 5m, 15m, 1h)
            // ============================================
            ...
            // ============================================
            // HEATMAP DE LIQUIDAÃâ¡Ãâ¢ES (estilo Coinglass)
            // ============================================
            ...
            const realLiquidations = workerLiqData
                ? {
                    ...
                    dataSource: `Binance Futures (${workerLiqData.totalCount} liquidaÃ§Ãµes 12h)`,
            ...
            // EMA 200 1h (peso 1.5 â distÃ¢ncia ponderada)
            ...
            // EMA 200 4h (peso 1.5 â distÃ¢ncia ponderada)
            ...
            // ADX 1h - ForÃ§a da tendÃªncia (peso 1)
            ...
            // ADX 4h (peso 1 â confirma forÃ§a da tendÃªncia em timeframe maior)
            ...
            // Stochastic 4h (peso 1 â confirma momentum em timeframe maior)
            ...
            // Net Volume 1h (peso 1.5) â threshold significativo
            ...
            // Net Volume 4h (peso 1.5) â threshold significativo
            ...
            // ============================================
            // MAPA DE RISCO DE LIQUIDAÃâ¡ÃO PENDENTE (peso variÃ¡vel atÃ© 2.2)
            // ============================================
            if (liquidationRiskMap.hasData) {
                ...
                // ConcentraÃ§Ã£o de risco prÃ³xima ao preÃ§o atual acelera o efeito de confluÃªncia
                if (liquidationRiskMap.nearPct >= 30 && liquidationRiskMap.signal !== 'NEUTRO') {
                    ...
                    confluenceDetails.push({
                        name: 'ConcentraÃ§Ã£o PrÃ³xima',
                        value: `${liquidationRiskMap.nearPct.toFixed(0)}% em atÃ© 3%`,
            ...
            // ============================================
            // S/R BREAKOUT DETECTION Ã¢â â Confluence
            // ============================================
            ...
            const _srHasVolume = _srVolRatio > 1.3; // Volume acima da mÃ©dia = confirmaÃ§Ã£o
            ...
            if (_srResBreakPct > 0.1 && _srHasVolume) {
                ...
                // Breakout without volume â weaker signal
                confluenceScore += 0.5;
                confluenceDetails.push({
                    name: 'Breakout ResistÃªncia',
            ...
            if (_srSupBreakPct > 0.1 && _srHasVolume) {
                ...
                // Breakdown without volume â weaker signal
                confluenceScore -= 0.5;
                confluenceDetails.push({
                    name: 'Rompimento Suporte',
            ...
            // ============================================
            // PINE V7 (BTC PRO) - Impacto condicional na confluÃªncia
            ...
            if (fundingRateValue > 0.05) {
                fundingSignal = 'bearish'; // Muito positivo = multidÃ£o comprada = short
                fundingScore = -1;
                ...
                fundingSignal = 'bullish'; // Negativo = multidÃ£o vendida = long
                fundingScore = 1;
            }
            ...
            const marketRegime = V2.detectMarketRegime ? 
                ...
                { regime: 'RANGING', regimeStrength: 0, regimeIcon: 'âï¸', regimeColor: '#f59e0b', regimeDescription: 'N/A', regimeImplication: '', isTrending: false, isRange: true };
            ...
            const volatilityMetrics = V2.calculateVolatilityMetrics ?
                ...
                { atr1h: calculateATR(klines1h), volRegime: 'NORMAL', volColor: '#f59e0b', volIcon: 'ð', volDescription: '' };
            ...
            if (sr && sr.supportCount >= 3 && currentPrice < sr.support * 1.01 && currentPrice > sr.support * 0.99) {
                confluenceScore += 2.5;
                confluenceDetails.push({ name: 'Suporte HistÃ³rico', value: `>= 3 toques nÃvel ${sr.support}`, signal: 'LONG', weight: 2.5, color: '#22c55e' });
            }
            if (sr && sr.resistanceCount >= 3 && currentPrice > sr.resistance * 0.99 && currentPrice < sr.resistance * 1.01) {
                confluenceScore -= 2.5;
                confluenceDetails.push({ name: 'ResistÃªncia HistÃ³rica', value: `>= 3 toques nÃvel ${sr.resistance}`, signal: 'SHORT', weight: 2.5, color: '#ef4444' });
            }
            ...
            // Probabilidade baseada em confluÃªncia contextual
            let probability = 50;
            if (totalScore > 0) {
                probability = Math.min(50 + (totalScore / maxScore) * 50, 100);
            } else if (totalScore < 0) {
                probability = Math.max(50 + (totalScore / maxScore) * 45, 5);
            }
            
            // ConfianÃ§a baseada em quantos indicadores concordam + regime alignment
            const alignedIndicators = Math.max(longIndicators, shortIndicators);
            const alignmentRatio = alignedIndicators / totalIndicators;
            let baseConfidence = Math.round(Math.min(alignmentRatio * 100 + Math.abs(totalScore) * 2, 100));
            ...
            const calcConsensusMultiplier = (details) => {
                ...
                if (dominant >= 5) return 1.40; // todos concordam
                if (dominant >= 4) return 1.25; // maioria forte
                return 1.00;
            };
            ...
            if (marketRegime.isTrending) {
                ...
                if ((totalScore > 0 && trendDirection > 0) || (totalScore < 0 && trendDirection < 0)) {
                    confidence = Math.min(confidence + 10, 100); // Aligned with trend
                } else {
            ...
            // Pine confidence modulation (impacta sÃ³ quando score >= 75)
            if (pineV7.active) {
                const pineMatchesSignal = (pineV7.direction === 'LONG' && signalType === 'long') || (pineV7.direction === 'SHORT' && signalType === 'short');
                if (pineMatchesSignal) {
                    confidence = Math.min(confidence + pineV7.confidenceBoost, 100);
                } else if (signalType !== 'neutral') {
                    confidence = Math.max(confidence - Math.round(pineV7.confidenceBoost * 0.7), 10);
                }
            }
        ...
        // ============================================
        // ANÃLISE DE PADRÃâ¢ES GRÃFICOS MULTI-TIMEFRAME
        // ============================================
        function analyzeChartPatterns(klines15m, klines1h, currentPrice) {
            ...
            // V7: Apenas timeframes estruturais (removido 1m/5m = ruÃ­do)
            const tfData = [
            ...
            result.confluenceScore = normalizedScore * 2; // Peso 2 para confluÃªncia geral
        ...
        function analyzeTimeframe(klines, currentPrice) {
            ...
            const volTrend = recentVol > avgVol * 1.2 ? 'AUMENTANDO' : recentVol < avgVol * 0.8 ? 'DIMINUINDO' : 'ESTÃVEL';
            
            // ===== DETECÃâ¡ÃO DE PADRÃâ¢ES DE CANDLESTICK =====
            const patterns = [];
            ...
            if (len >= 3) {
                ...
                if (fullRange > 0 && body / fullRange < 0.1) {
                    patterns.push({ name: 'Doji', icon: 'Ã¢ÅÅ¡', type: 'reversal', bias: 'neutro' });
                }
                // Hammer / Inverted Hammer
                if (fullRange > 0 && lowerWick > body * 2 && upperWick < body * 0.5) {
                    const isBull = c > o;
                    patterns.push({ name: 'Martelo', icon: 'Ã°Å¸âÂ¨', type: 'reversal', bias: isBull ? 'alta' : 'alta' });
                }
                if (fullRange > 0 && upperWick > body * 2 && lowerWick < body * 0.5) {
                    patterns.push({ name: 'Shooting Star', icon: 'Ã¢Â­Â', type: 'reversal', bias: 'baixa' });
                }
                // Engulfing
                if (c > o && prev_c < prev_o && c > prev_o && o < prev_c) {
                    patterns.push({ name: 'Engolfo Alta', icon: 'Ã°Å¸Å¸Â¢', type: 'reversal', bias: 'alta' });
                }
                if (c < o && prev_c > prev_o && c < prev_o && o > prev_c) {
                    patterns.push({ name: 'Engolfo Baixa', icon: 'Ã°Å¸âÂ´', type: 'reversal', bias: 'baixa' });
                }
                // Pin Bar
                if (fullRange > 0 && lowerWick / fullRange > 0.6 && body / fullRange < 0.2) {
                    patterns.push({ name: 'Pin Bar Alta', icon: 'Ã°Å¸âÅ', type: 'reversal', bias: 'alta' });
                }
                if (fullRange > 0 && upperWick / fullRange > 0.6 && body / fullRange < 0.2) {
                    patterns.push({ name: 'Pin Bar Baixa', icon: 'Ã°Å¸âÅ', type: 'reversal', bias: 'baixa' });
                }
                // Marubozu (corpo > 90% da range)
                if (fullRange > 0 && body / fullRange > 0.9) {
                    const isBull = c > o;
                    patterns.push({ name: isBull ? 'Marubozu Alta' : 'Marubozu Baixa', icon: isBull ? 'Ã°Å¸âÂª' : 'Ã°Å¸ââ¬', type: 'continuation', bias: isBull ? 'alta' : 'baixa' });
                }
                // Three White Soldiers / Three Black Crows (Ãºltimas 3 velas)
                if (len >= 4) {
                    ...
                    if (c3[0] > o3[0] && c3[1] > o3[1] && c3[2] > o3[2] && c3[1] > c3[0] && c3[2] > c3[1]) {
                        patterns.push({ name: '3 Soldados', icon: 'Ã°Å¸Å¸Â¢Ã°Å¸Å¸Â¢Ã°Å¸Å¸Â¢', type: 'continuation', bias: 'alta' });
                    }
                    if (c3[0] < o3[0] && c3[1] < o3[1] && c3[2] < o3[2] && c3[1] < c3[0] && c3[2] < c3[1]) {
                        patterns.push({ name: '3 Corvos', icon: 'Ã°Å¸âÂ´Ã°Å¸âÂ´Ã°Å¸âÂ´', type: 'continuation', bias: 'baixa' });
                    }
                }
                ...
                if (len >= 4) {
                    ...
                    if (pp.c < pp.o && mid.body < prevBody * 0.3 && c > o && c > (pp.o + pp.c) / 2) {
                        patterns.push({ name: 'Morning Star', icon: 'Ã°Å¸Åâ¦', type: 'reversal', bias: 'alta' });
                    }
                    if (pp.c > pp.o && mid.body < prevBody * 0.3 && c < o && c < (pp.o + pp.c) / 2) {
                        patterns.push({ name: 'Evening Star', icon: 'Ã°Å¸Åâ ', type: 'reversal', bias: 'baixa' });
                    }
                }
            }
            
            // Calcular sinal com mais critÃ©rios
            let signal = 'NEUTRO';
            let strength = 0;
        ...
        function findKeyLevels(klines, currentPrice) {
            ...
            // Filtrar nÃ­veis prÃ³ximos ao preÃ§o atual (ÃÂ±10%)
        ...
        function calculateLiquidationHeatmap(currentPrice, openInterest, orderBook, takerBuySellVol) {
            ...
            // Estimar nÃ­veis de liquidaÃ§Ã£o baseado em alavancagem tÃ­pica
            // NÃ­veis comuns: 2x, 3x, 5x, 10x, 20x, 25x, 50x, 100x
            const leverages = [2, 3, 5, 10, 20, 25, 50, 100];
            
            // Para LONG: liquidaÃ§Ã£o = entrada * (1 - 1/alavancagem)
            // Para SHORT: liquidaÃ§Ã£o = entrada * (1 + 1/alavancagem)
            ...
            // Calcular risco total de liquidaÃ§Ã£o
            ...
            // Analisar Taker Buy/Sell para ver pressÃ£o
        ...
        function estimateVolumeAtLevel(orderBook, targetPrice, side) {
            ...
            let volume = 0;
            const tolerance = targetPrice * 0.005; // 0.5% de tolerÃ¢ncia
        ...
        // ============================================
        // DETECÃâ¡ÃO DE INÃÂCIO DE TENDÃÅ NCIA (REAL)
        // Identifica quando uma nova tendÃªncia estÃ¡ comeÃ§ando
        // ============================================
        function detectTrendStart(klines1m, klines5m, klines15m, klines1h, currentPrice) {
            ...
            // 2. BREAKOUT DE CONSOLIDAÃâ¡ÃO
            ...
            if (rangeSize < 3) {
                if (currentPrice > recentHigh * 1.001) {
                    result.triggers.push({ trigger: 'Breakout de Alta (rompeu resistÃªncia)', direction: 'UP', weight: 2.5 });
            ...
            // 3. VOLUME SPIKE - Volume anormal indica inÃ­cio de movimento
            ...
            // 4. DIVERGÃÅ NCIA RSI - PreÃ§o faz novo low, RSI nÃ£o confirma
            ...
            if (rsi.length >= 10) {
                ...
                if (priceNewLow && rsiHigherLow) {
                    result.triggers.push({ trigger: 'DivergÃªncia Alta RSI (reversÃ£o provÃ¡vel)', direction: 'UP', weight: 2 });
                }
                ...
                if (priceNewHigh && rsiLowerHigh) {
                    result.triggers.push({ trigger: 'DivergÃªncia Baixa RSI (reversÃ£o provÃ¡vel)', direction: 'DOWN', weight: 2 });
                }
            }
            
            // 5. PADRÃO ENGULFING (Candlestick de reversÃ£o)
            if (klines1h.length >= 3) {
                ...
                if (prevClose < prevOpen && currClose > currOpen && 
                    ...
                    result.triggers.push({ trigger: 'Bullish Engulfing (reversÃ£o de alta)', direction: 'UP', weight: 1.5 });
                }
                // Bearish Engulfing
                if (prevClose > prevOpen && currClose < currOpen && 
                    currOpen >= prevClose && currClose <= prevOpen) {
                    result.triggers.push({ trigger: 'Bearish Engulfing (reversÃ£o de baixa)', direction: 'DOWN', weight: 1.5 });
                }
            }
        ...
        // ============================================
        // HEATMAP DE LIQUIDAÃâ¡Ãâ¢ES â DADOS REAIS
        // Baseado em ordens forÃ§adas (allForceOrders) da Binance
        // + agregaÃ§Ã£o via CoinGlass public endpoints
        // Dados acumulados server-side via Cloudflare KV (compartilhado entre todos os usuÃ¡rios)
        // ============================================
        ...
        function analyzeRealLiquidations(forceOrders, currentPrice, openInterest, longShortRatio) {
            ...
            // Ã¢ââ¬Ã¢ââ¬Ã¢ââ¬ FONTE PRIMÃRIA: Ordens forÃ§adas reais da Binance Ã¢ââ¬Ã¢ââ¬Ã¢ââ¬
            ...
            if (validForceOrders.length > 0) {
                ...
                result.dataSource = `Binance (${validForceOrders.length} liquidaÃ§Ãµes)`;
                
                let longLiqVol = 0, shortLiqVol = 0;
                let longCount = 0, shortCount = 0;
                const levels = [];
                const now = Date.now();
                const recentWindow = 12 * 60 * 60 * 1000; // Ãºltimas 12h
                ...
                validForceOrders.forEach(order => {
                    ...
                    // side=BUY Ã¢â â SHORT foi liquidado (compra forÃ§ada p/ fechar short)
                    // side=SELL Ã¢â â LONG foi liquidado (venda forÃ§ada p/ fechar long)
                ...
                result.liquidationLevels = levels.slice(0, 20); // top 20 mais prÃ³ximos
            ...
            // Ã¢ââ¬Ã¢ââ¬Ã¢ââ¬ FALLBACK: Estimativa via Open Interest Ã¢ââ¬Ã¢ââ¬Ã¢ââ¬
        ...
        function buildLiquidationRiskMap(realLiquidations, currentPrice) {
            ...
            bucketDefs.forEach(def => {
                ...
                if (def.max === Number.POSITIVE_INFINITY) {
                    ...
                    def.label = _fmtP(lo) + ' Ã¢â¬â ' + _fmtP(hiUp);
                }
            });
            ...
            if (pendingLevels.length > 0) {
                ...
                // DistribuiÃ§Ã£o sintÃ©tica quando sÃ³ temos agregados (sem nÃ­veis por distÃ¢ncia)
            ...
            let insight = `Maior concentraÃ§Ã£o em ${strongestCluster.label}`;
            if (signal === 'LONG') insight += ' com mais shorts vulnerÃ¡veis';
            if (signal === 'SHORT') insight += ' com mais longs vulnerÃ¡veis';
            if (signal === 'NEUTRO') insight += ' e distribuiÃ§Ã£o equilibrada';
        ...
        function calculateOIChange(klines, ticker24h) {
            // Estimativa baseada em variaÃ§Ã£o de volume
        ...
        function calculateCVD(trades) {
            ...
            trades.forEach(t => {
                ...
                const usdVol = qty * price; // usar volume em USD para precisÃ£o
                if (t.isBuyerMaker) {
                    sellVolume += usdVol; // Maker Ã© comprador, taker vendeu (sell market order)
                } else {
                    buyVolume += usdVol; // Maker Ã© vendedor, taker comprou (buy market order)
                }
            });
        ...
        // Suporte e ResistÃªncia baseados em Swing Highs/Lows + MÃ©dias MÃ³veis
        ...
        // EMA - Exponential Moving Average (seed correto via SMA dos primeiros N perÃ­odos)
        function calculateEMA(klines, period = 200) {
            if (!klines || klines.length < period) {
                // Se nÃ£o temos dados suficientes, usar SMA com dados disponÃ­veis
        ...
        function calculateNetVolume(klines) {
            ...
            klines.forEach(k => {
                ...
                // Se fechou acima da abertura, Ã© volume de compra
                if (close > open) {
                    buyVolume += volume;
                } else if (close < open) {
                    sellVolume += volume;
        ...
        function generateLocalSummary(signalType, confidence, indicators, symbol) {
            ...
            if (indicators.movingAverages) {
                ...
                if (aboveEmas === 3 && aboveSmas >= 2) {
                    maAnalysis = 'ð MÃ©dias MÃ³veis: FORTE tendÃªncia de alta - preÃ§o acima de todas as EMAs e principais SMAs.';
                } else if (aboveEmas === 0 && aboveSmas <= 1) {
                    maAnalysis = 'ð MÃ©dias MÃ³veis: FORTE tendÃªncia de baixa - preÃ§o abaixo de todas as EMAs e principais SMAs.';
                } else if (aboveEmas >= 2) {
                    maAnalysis = 'ð MÃ©dias MÃ³veis: TendÃªncia de curto prazo BULLISH - preÃ§o acima das EMAs rÃ¡pidas.';
                } else {
                    maAnalysis = 'ð MÃ©dias MÃ³veis: ConsolidaÃ§Ã£o - preÃ§o entre mÃ©dias indica indecisÃ£o.';
                }
            }
            
            // AnÃ¡lise de Atividade de Baleias
            let whaleAnalysis = '';
            if (indicators.whaleActivity) {
                ...
                if (whale.level === 'muito_alta' || whale.level === 'alta') {
                    if (whale.direction === 'compra') {
                        whaleAnalysis = 'Ã°Å¸Ââ¹ Baleias: Atividade ALTA com predominÃ¢ncia de COMPRA - institucionais acumulando.';
                    } else if (whale.direction === 'venda') {
                        whaleAnalysis = 'Ã°Å¸Ââ¹ Baleias: Atividade ALTA com predominÃ¢ncia de VENDA - institucionais distribuindo.';
                    } else {
                        whaleAnalysis = 'Ã°Å¸Ââ¹ Baleias: Atividade ALTA detectada - monitorar direÃ§Ã£o.';
                    }
                } else if (whale.level === 'moderada') {
                    whaleAnalysis = 'Ã°Å¸Ââ¹ Baleias: Atividade moderada no mercado.';
                }
            }
            
            // AnÃ¡lise do Book Imbalance
            let bookAnalysis = '';
            if (indicators.bookImbalance) {
                const ratio = indicators.bookImbalance.ratio;
                if (ratio > 1.5) {
                    bookAnalysis = 'Ã°Å¸ââ Order Book: Forte pressÃ£o compradora (${ratio.toFixed(2)}x mais bids que asks).';
                } else if (ratio < 0.67) {
                    bookAnalysis = 'Ã°Å¸ââ¢ Order Book: Forte pressÃ£o vendedora (${(1/ratio).toFixed(2)}x mais asks que bids).';
                }
            }
            ...
            if (indicators.marketRegime) {
                ...
                regimeAnalysis = `ð¡ï¸Â Regime: ${r.regimeIcon} ${r.regimeDescription}. ${r.regimeImplication}`;
                if (r.squeezeDetected) {
                    regimeAnalysis += '\nð BOLLINGER SQUEEZE â explosÃ£o de volatilidade iminente!';
                }
            }
            if (indicators.marketStructure) {
                const s = indicators.marketStructure;
                if (s.structureDescription) {
                    structureAnalysis = `Ã°Å¸âÂ Estrutura: ${s.structureDescription}`;
                }
                if (s.liquiditySweeps?.detected) {
                    structureAnalysis += `\nÃ°Å¸Å½Â¯ ${s.liquiditySweeps.description}`;
                }
            }
            if (indicators.cvdAdvanced) {
                ...
                if (c.absorption) cvdAdvAnalysis += `Ã°Å¸Ââ¹ CVD: ${c.absorption.description}\n`;
                if (c.breakout) cvdAdvAnalysis += `Ã°Å¸âÂ¥ CVD: ${c.breakout.description}\n`;
            }
            ...
            if (indicators.bigTechMacro) {
                ...
                bigTechAnalysis = `Ã°Å¸ÂÂ¢ Big Tech: ${bt.bigTechSentiment} (${techSummary})`;
                if (bt.fearGreed) {
                    bigTechAnalysis += `\nÃ°Å¸Å½Â­ Fear & Greed: ${bt.fearGreed.value}/100 â ${bt.fearGreed.classification}`;
                }
                if (bt.indices?.length > 0) {
                    const sp = bt.indices.find(i => i.symbol === '^GSPC');
                    const vix = bt.indices.find(i => i.symbol === '^VIX');
                    if (sp) bigTechAnalysis += `\nð S&P 500: ${sp.changePercent > 0 ? '+' : ''}${sp.changePercent.toFixed(2)}%`;
                    if (vix) bigTechAnalysis += ` | Ã°Å¸ËÂ± VIX: ${vix.price.toFixed(1)}`;
                }
                if (bt.treasuryYields?.isInverted) {
                    bigTechAnalysis += '\nÃ¢Å¡Â Ã¯Â¸Â CURVA DE JUROS INVERTIDA â sinal de recessÃ£o que pressiona risk assets';
                }
            }
            ...
            if (signalType === 'long') {
                return `ð SINAL LONG DETECTADO para ${crypto}

O preÃ§o estÃ¡ ${indicators.priceLocation === 'below_value' ? 'ABAIXO da Ã¡rea de valor (barato)' : 'na regiÃ£o inferior da Ã¡rea de valor'}. O Funding Rate ${indicators.fundingSignal === 'bullish' ? 'negativo indica que a multidÃ£o estÃ¡ vendida (oportunidade contrÃ¡ria)' : 'estÃ¡ neutro'}.

O CVD mostra ${indicators.cvdSignal === 'bullish' ? 'predominÃ¢ncia de compras agressivas a mercado' : indicators.cvdSignal === 'absorption_bullish' ? 'ABSORÃâ¡ÃO de vendas por compradores (baleias acumulando)' : 'fluxo equilibrado'}.

O Order Book revela ${indicators.bookSignal === 'bid_heavy' ? 'forte suporte de bids (compradores posicionados)' : 'equilÃ­brio entre bids e asks'}.

${maAnalysis}
${whaleAnalysis}

${indicators.rsiSignal === 'oversold' ? 'Ã¢Å¡Â Ã¯Â¸Â RSI em sobrevenda - momento Ã³timo para entrada!' : ''}
${indicators.lsSignal === 'bullish' ? 'Ã°Å¸âÂ¡ Long/Short Ratio indica shorts excessivos - potencial short squeeze.' : ''}

${v2Block ? '--- AnÃ¡lise Detalhada ---\n' + v2Block + '\n' : ''}
ConfianÃ§a: ${confidence}%`;
            } else if (signalType === 'short') {
                return `ð SINAL SHORT DETECTADO para ${crypto}

O preÃ§o estÃ¡ ${indicators.priceLocation === 'above_value' ? 'ACIMA da Ã¡rea de valor (caro)' : 'na regiÃ£o superior da Ã¡rea de valor'}. O Funding Rate ${indicators.fundingSignal === 'bearish' ? 'muito positivo indica multidÃ£o excessivamente comprada (risco de liquidaÃ§Ã£o)' : 'estÃ¡ elevado'}.

O CVD mostra ${indicators.cvdSignal === 'bearish' ? 'predominÃ¢ncia de vendas agressivas' : indicators.cvdSignal === 'absorption_bearish' ? 'ABSORÃâ¡ÃO de compras por vendedores (distribuiÃ§Ã£o institucional)' : 'pressÃ£o vendedora crescente'}.

O Order Book revela ${indicators.bookSignal === 'ask_heavy' ? 'forte resistÃªncia de asks (vendedores posicionados)' : 'pressÃ£o de oferta'}.

${maAnalysis}
${whaleAnalysis}

${indicators.rsiSignal === 'overbought' ? 'Ã¢Å¡Â Ã¯Â¸Â RSI em sobrecompra - momento Ã³timo para short!' : ''}
${indicators.lsSignal === 'bearish' ? 'Ã°Å¸âÂ¡ Long/Short Ratio indica longs excessivos - potencial long squeeze.' : ''}

${v2Block ? '--- AnÃ¡lise Detalhada ---\n' + v2Block + '\n' : ''}
ConfianÃ§a: ${confidence}%`;
            } else {
                // Verificar posiÃ§Ã£o do preÃ§o em relaÃ§Ã£o ao VAH/VAL
                ...
                if (currentPrice > indicators.vah) {
                    pricePositionMsg = `O preÃ§o atual ($${currentPrice.toFixed(2)}) estÃ¡ ACIMA da VAH ($${indicators.vah?.toFixed(2)}), mas nÃ£o hÃ¡ confluÃªncia suficiente para confirmar continuaÃ§Ã£o de alta.`;
                    recommendationMsg = `Ã°Å¸Å¡Â« RecomendaÃ§Ã£o: NÃO OPERAR agora.
Ã¢â¬Â¢ O preÃ§o JÃ rompeu VAH - aguarde reteste da VAH ($${indicators.vah?.toFixed(2)}) como SUPORTE para LONG
Ã¢â¬Â¢ Ou aguarde retorno para dentro da Ã¡rea de valor para SHORT
Ã¢â¬Â¢ Evite comprar no topo sem confirmaÃ§Ã£o de volume`;
                } else if (currentPrice < indicators.val) {
                    pricePositionMsg = `O preÃ§o atual ($${currentPrice.toFixed(2)}) estÃ¡ ABAIXO da VAL ($${indicators.val?.toFixed(2)}), mas nÃ£o hÃ¡ confluÃªncia suficiente para confirmar continuaÃ§Ã£o de baixa.`;
                    recommendationMsg = `Ã°Å¸Å¡Â« RecomendaÃ§Ã£o: NÃO OPERAR agora.
Ã¢â¬Â¢ O preÃ§o JÃ rompeu VAL - aguarde reteste da VAL ($${indicators.val?.toFixed(2)}) como RESISTÃÅ NCIA para SHORT
Ã¢â¬Â¢ Ou aguarde retorno para dentro da Ã¡rea de valor para LONG
Ã¢â¬Â¢ Evite vender no fundo sem confirmaÃ§Ã£o de volume`;
                } else {
                    pricePositionMsg = `O preÃ§o atual ($${currentPrice.toFixed(2)}) estÃ¡ DENTRO da Ã¡rea de valor (VAL: $${indicators.val?.toFixed(2)} | VAH: $${indicators.vah?.toFixed(2)}).`;
                    recommendationMsg = `Ã°Å¸Å¡Â« RecomendaÃ§Ã£o: NÃO OPERAR agora.
Ã¢â¬Â¢ Aguarde rompimento claro da VAH ($${indicators.vah?.toFixed(2)}) com volume para LONG
Ã¢â¬Â¢ Aguarde rompimento claro da VAL ($${indicators.val?.toFixed(2)}) com volume para SHORT`;
                }
                
                return `Ã¢ÂÂ³ NEUTRO â ${crypto}

${pricePositionMsg}

NÃ£o hÃ¡ confluÃªncia suficiente entre os indicadores para recomendar operaÃ§Ã£o.
...
${v2Block ? '--- AnÃ¡lise Detalhada ---\n' + v2Block + '\n\n' : ''}Indicadores atuais:
Ã¢â¬Â¢ Funding Rate: ${indicators.fundingSignal}
Ã¢â¬Â¢ CVD: ${indicators.cvdSignal}
Ã¢â¬Â¢ Order Book: ${indicators.bookSignal}

Ã¢Å¡Â Ã¯Â¸Â ConfianÃ§a para operaÃ§Ã£o: BAIXA. Sem sinal direcional.`;
            }
        }

        // Ã¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢Â
        // GROQ AI â RelatÃ³rio de IA real via Llama 3.3 70B
        // Ã¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢Â
        ...
        const GROQ_URL = ''+ window.APP_CONFIG.CALENDAR_WORKER_URL +'/proxy/groq/openai/v1/chat/completions';
        const _aiSummaryCache = {};

        // Evitar acÃºmulo de memÃ³ria no cache de AI summaries
        function _cleanAISummaryCache() {
            const keys = Object.keys(_aiSummaryCache);
            if (keys.length > 50) {
                // Remover entradas mais antigas (manter Ãºltimas 20)
                keys.slice(0, keys.length - 20).forEach(k => delete _aiSummaryCache[k]);
            }
        }

        // Sync wrapper â returns local fallback instantly
        ...
        async function fetchAISummary(analysis, symbol) {
            ...
            const systemPrompt = `VocÃª Ã© um analista quantitativo sÃªnior de criptomoedas. Gere um relatÃ³rio tÃ©cnico conciso em portuguÃªs brasileiro (PT-BR) com base nos dados fornecidos.

Regras:
- MÃ¡ximo 800 caracteres
- NÃ£o use markdown, apenas texto limpo com emojis para seÃ§Ãµes
- Comece com o sinal (ð LONG / ð SHORT / Ã¢ÂÂ³ NEUTRO)
- A confianÃ§a DEVE ser EXATAMENTE ${dataPayload.confidence}% â este valor jÃ¡ foi calculado pelo motor de confluÃªncia, NÃO calcule nem invente outro valor
- NUNCA mencione probabilidade, apenas a ConfianÃ§a.
- Analise: regime de mercado, volume profile, order flow (CVD, funding), microestrutura, sentimento
- DÃª uma conclusÃ£o objetiva: operar ou nÃ£o, e por quÃª
- Se NEUTRO, explique o que esperar para entrar
- Use linguagem direta de trader profissional
- NÃO invente dados, use APENAS os fornecidos`;

            try {
                const userPrompt = `Dados da anÃ¡lise tÃ©cnica de ${crypto} (${symbol}):\n${JSON.stringify(dataPayload)}`;
                let aiText = null;
                ...
                if (aiText) {
                    ...
                    if (realConf != null) {
                        // Replace patterns like "confianÃ§a: 73%" or "ConfianÃ§a de 73%" or just "73% de confianÃ§a"
                        aiText = aiText.replace(
                            /(confian[Ã§c]a[:\s]+(?:de\s+)?)(\d{1,3})(%)/gi,
                            `$1${realConf}$3`
                        );
                        // Also replace the first standalone percentage at the start (e.g., "ð LONG | 73%")
                        aiText = aiText.replace(
                            /^([^\n]{0,60}?)\b(\d{1,3})(%\s)/m,
        ...
        async function updateAISummaryInModal(analysis, symbol) {
            ...
            if (aiResult) {
                ...
                // Groq failed â show local fallback with blended confidence
                ...
                const prefix = noKey
                    ? 'Ã¢âÂ¹Ã¯Â¸Â RelatÃ³rio em modo local. Para IA remota via Groq, configure CALENDAR_WORKER_URL e GROQ_API_KEY no Worker.\n\n'
                    : 'Ã¢Å¡Â Ã¯Â¸Â IA indisponÃ­vel â anÃ¡lise local:\n\n';
        ...
        function renderLiquidationMapSection(realLiquidations, liquidationRiskMap, formatBigNumber, formatPrice) {
            if (!realLiquidations?.hasData || !liquidationRiskMap?.hasData) {
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">Mapa de LiquidaÃ§Ãµes</div>
                    ...
                    <div style="margin-top: 12px; padding: 18px; background: var(--bg-tertiary); border-radius: 12px; text-align: center; color: var(--text-muted); font-size: 12px;">
                        Sem dados suficientes no momento. Atualiza a cada ciclo da anÃ¡lise tÃ©cnica (5 min).
                    </div>
                </div>
                `;
            }
            ...
            const signalLabel = riskSignal === 'LONG'
                ? 'ViÃ©s de alta (short squeeze)'
                : riskSignal === 'SHORT'
                    ? 'ViÃ©s de baixa (flush de longs)'
                    : 'Sem dominÃ¢ncia clara';
            ...
            const modeLabel = liquidationRiskMap.mode === 'pending-levels'
                ? 'NÃ­veis reais por distÃ¢ncia do preÃ§o'
                : 'DistribuiÃ§Ã£o agregada por Open Interest';
            ...
            return `
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">Mapa de LiquidaÃ§Ãµes (Risco Pendente)</div>
                    ...
                    <div style="margin-top: 10px; padding: 12px; border-radius: 10px; background: var(--bg-tertiary); border: 1px solid rgba(148, 163, 184, 0.18);">
                        <div style="display: flex; justify-content: space-between; align-items: center; gap: 10px;">
                            ...
                            <div style="text-align: right;">
                                <div style="font-size: 10px; color: var(--text-muted); text-transform: uppercase;">Impacto ConfluÃªncia</div>
                                <div style="font-size: 13px; font-weight: 800; color: ${signalColor};">${impactLabel}</div>
                            </div>
                        </div>
                        <div style="margin-top: 8px; font-size: 11px; color: var(--text-muted);">
                            ${liquidationRiskMap.insight || 'Sem insight adicional'} | ConcentraÃ§Ã£o em atÃ© 3%: ${(liquidationRiskMap.nearPct || 0).toFixed(1)}%
                        </div>
                    </div>
                    ...
                    <div style="margin-top: 12px; padding: 12px; border-radius: 10px; background: var(--bg-tertiary); border: 1px solid rgba(148, 163, 184, 0.18);">
                        <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 10px; text-transform: uppercase;">
                            Escada de risco por distÃ¢ncia (% do preÃ§o atual: $${formatPrice(realLiquidations.currentPrice || 0)})
                        </div>
                        <div style="display: grid; grid-template-columns: 90px 1fr 1fr; gap: 8px; margin-bottom: 6px;">
                            <div></div>
                    ...
                    <div style="margin-top: 10px; font-size: 10px; color: var(--text-muted);">
                        AtualizaÃ§Ã£o: ${realLiquidations.lastUpdate || '-'} | Este mapa influencia confluÃªncia, e confianÃ§a final.
                    </div>
                </div>
            `;
        }
        ...
        function renderTechnicalAnalysis(analysis, crypto) {
            ...
            if (confidence < 50 && signalType !== 'long' && signalType !== 'short') {
                ...
                // Has directional bias but low confidence â show NEUTRO
                displaySignal = 'NEUTRO';
                signalType = 'aguardar';
            }
            
            // Ã¢â¢ÂÃ¢â¢ÂÃ¢â¢Â SYNC CONFIDENCE WITH MARKET REGIME Ã¢â¢ÂÃ¢â¢ÂÃ¢â¢Â
            ...
            // AI summary will be loaded async from Groq â no local text
            ...
            body.innerHTML = `
                ...
                <div style="display: flex; align-items: center; gap: 14px; margin-bottom: 18px; padding: 14px 16px; background: linear-gradient(135deg, var(--bg-card) 0%, var(--bg-elevated) 100%); border-radius: 16px; border: 1px solid var(--border-subtle); box-shadow: 0 2px 12px rgba(0,0,0,0.15);">
                    ...
                    <div style="padding: 6px 12px; background: rgba(99,102,241,0.12); border: 1px solid rgba(99,102,241,0.2); border-radius: 20px; font-size: 10px; font-weight: 700; color: #818cf8; letter-spacing: 0.5px; white-space: nowrap;">ANÃLISE</div>
                </div>
                ...
                <div class="ta-signal-card ${signalType}">
                    <div class="ta-signal-header">
                        ...
                        <div class="ta-signal-info">
                            ...
                            ${isV4Active ? `<div style="display: flex; align-items: center; gap: 8px; margin-top: 4px; flex-wrap: wrap;">
                                ...
                                <span style="font-size: 10px; color: var(--text-muted); white-space: nowrap;">Ã¢Åâ¦ ${analysis.v4GatesPassed || 0}/${analysis.v4GatesTotal || 9} confirmaÃ§Ãµes</span>
                                ${analysis.dataIntegrity && !analysis.dataIntegrity.valid ? `<span style="font-size: 9px; padding: 2px 6px; border-radius: 4px; background: rgba(239,68,68,0.2); color: #f87171; font-weight: 700;">Ã¢Å¡Â Ã¯Â¸Â DADOS</span>` : ''}
                            </div>
                    ...
                    <div class="ta-levels">
                        ...
                        <div class="ta-level-item">
                            ...
                            <div class="ta-level-value stop">${dynamicTargets ? dynamicTargets.riskPercent + '%' : (entry ? (((Math.abs((stopLoss || entry) - entry)) / entry) * 100).toFixed(2) + '%' : 'â')}</div>
                        </div>
                    </div>
                    ${dynamicTargets ? `
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; margin-top: 8px;">
                        ...
                        <div style="background: rgba(34,197,94,0.2); padding: 10px; border-radius: 8px; text-align: center; border: 1px solid rgba(34,197,94,0.4);">
                            <div style="font-size: 9px; color: #10b981; text-transform: uppercase; font-weight: 700; white-space: nowrap;">TP3 (ATRÃâ4)</div>
                    ...
                    <div class="ta-rr-card">
                        ...
                        <div class="ta-rr-item">
                            ...
                            <div class="ta-rr-value pnl-positive">${entry ? ((signalType === 'long' ? '+' : '') + ((((takeProfit || entry) - entry) / entry) * 100).toFixed(2) + '%') : 'â'}</div>
                        </div>
                        <div class="ta-rr-item">
                            <div class="ta-rr-label">Risco</div>
                            <div class="ta-rr-value pnl-negative">${entry ? (((((stopLoss || entry) - entry) / entry) * 100).toFixed(2) + '%') : 'â'}</div>
                        </div>
                    </div>
                    `}
                    ` : `
                    <div style="padding: 20px; background: var(--bg-tertiary); border-radius: 12px; text-align: center;">
                        <div style="font-size: 16px; font-weight: 700; color: #f59e0b; margin-bottom: 8px;">Ã¢Å¡Â Ã¯Â¸Â NÃO RECOMENDADO OPERAR</div>
                        <div style="font-size: 12px; color: var(--text-muted);">ConfluÃªncia insuficiente. Aguarde um sinal mais claro.</div>
                ...
                <!-- Ã¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢Â V5 NEW PANELS Ã¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢Â -->
                ...
                <div class="ta-section" style="border: 1px solid ${analysis.btcAlignment.alignment === 'ALIGNED' ? 'rgba(34,197,94,0.3)' : analysis.btcAlignment.alignment === 'DIVERGING' ? 'rgba(239,68,68,0.3)' : 'rgba(100,116,139,0.2)'};">
                    <div class="ta-section-header">
                        ...
                        <div>
                            ...
                            <div class="ta-section-subtitle">CorrelaÃ§Ã£o e direÃ§Ã£o relativa ao Bitcoin</div>
                        </div>
                    </div>
                    <div style="padding: 14px; background: ${analysis.btcAlignment.alignment === 'ALIGNED' ? 'rgba(34,197,94,0.06)' : analysis.btcAlignment.alignment === 'DIVERGING' ? 'rgba(239,68,68,0.06)' : 'var(--bg-tertiary)'}; border-radius: 12px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            <div>
                                <div style="font-size: 16px; font-weight: 800; color: ${analysis.btcAlignment.alignment === 'ALIGNED' ? '#22c55e' : analysis.btcAlignment.alignment === 'DIVERGING' ? '#ef4444' : '#94a3b8'};">
                                    ${analysis.btcAlignment.alignment === 'ALIGNED' ? 'Ã¢Åâ¦ ALINHADO' : analysis.btcAlignment.alignment === 'DIVERGING' ? 'Ã¢Å¡Â Ã¯Â¸Â DIVERGENTE' : 'âï¸ NEUTRO'}
                                </div>
                                <div style="font-size: 11px; color: var(--text-secondary); margin-top: 2px;">${analysis.btcAlignment.description || ''}</div>
                            </div>
                            <div style="text-align: right;">
                                <div style="font-size: 9px; color: var(--text-muted); white-space: nowrap;">CorrelaÃ§Ã£o</div>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px;">
                            <div style="background: var(--bg-card); padding: 8px; border-radius: 8px; text-align: center;">
                                ...
                                <div style="font-size: 12px; font-weight: 700; color: ${analysis.btcAlignment.btcTrend === 'UP' ? '#22c55e' : analysis.btcAlignment.btcTrend === 'DOWN' ? '#ef4444' : '#f59e0b'};">${analysis.btcAlignment.btcTrend === 'UP' ? 'Ã¢âÂ² Alta' : analysis.btcAlignment.btcTrend === 'DOWN' ? 'â¼ Baixa' : 'â Lateral'}</div>
                            </div>
                            <div style="background: var(--bg-card); padding: 8px; border-radius: 8px; text-align: center;">
                                <div style="font-size: 9px; color: var(--text-muted); white-space: nowrap;">ForÃ§a Relativa</div>
                            ...
                            <div style="background: var(--bg-card); padding: 8px; border-radius: 8px; text-align: center;">
                                ...
                                <div style="font-size: 12px; font-weight: 700; color: ${analysis.btcAlignment.riskLevel === 'HIGH' ? '#ef4444' : analysis.btcAlignment.riskLevel === 'MEDIUM' ? '#f59e0b' : '#22c55e'};">${analysis.btcAlignment.riskLevel === 'HIGH' ? 'Ã°Å¸âÂ´ Alto' : analysis.btcAlignment.riskLevel === 'MEDIUM' ? 'Ã°Å¸Å¸Â¡ MÃ©dio' : 'Ã°Å¸Å¸Â¢ Baixo'}</div>
                            </div>
                        </div>
                        ...
                        <div style="margin-top: 4px; font-size: 9px; color: var(--text-muted); text-align: center;">
                            Janela dominante: ${analysis.btcAlignment.dominantWindow || '48h'} | TendÃªncia corr: ${analysis.btcAlignment.corrTrend || 'STABLE'}
                        </div>
                        ` : ''}
                    </div>
                </div>
                ...
                <div class="ta-section" style="border: 1px solid rgba(139,92,246,0.2); background: linear-gradient(135deg, rgba(139,92,246,0.03) 0%, transparent 100%);">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">DiagnÃ³stico de Mercado</div>
                            <div class="ta-section-subtitle">Percentil, Qualidade e SaturaÃ§Ã£o</div>
                        </div>
                    </div>
                    <div style="display: grid; grid-template-columns: 1fr; gap: 10px;">
                        ...
                        <div style="padding: 12px; background: var(--bg-tertiary); border-radius: 10px; border-left: 3px solid ${analysis.regimeQuality.quality === 'Acelerando' || analysis.regimeQuality.quality === 'Forte' ? '#22c55e' : analysis.regimeQuality.quality === 'EstÃ¡vel' ? '#3b82f6' : analysis.regimeQuality.quality === 'Fraco' || analysis.regimeQuality.quality === 'Enfraquecendo' ? '#f59e0b' : '#ef4444'};">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <div>
                        ...
                        <div style="padding: 12px; background: var(--bg-tertiary); border-radius: 10px; border-left: 3px solid ${(analysis.saturation.saturationPercent || 0) >= 80 ? '#ef4444' : (analysis.saturation.saturationPercent || 0) >= 50 ? '#f59e0b' : '#22c55e'};">
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                                <div>
                                    <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; text-transform: uppercase;">SaturaÃ§Ã£o / ExtensÃ£o</div>
                            ...
                            <div style="display: flex; justify-content: space-between; margin-top: 4px; font-size: 9px; color: var(--text-muted); white-space: nowrap;">
                                <span>0% â InÃ­cio</span>
                                <span>Risco: ${analysis.saturation.risk || 'N/A'}</span>
                                <span>100% â Exausto</span>
                            </div>
                        </div>
                        ` : ''}
                    </div>
                ...
                <div class="ta-section" style="border: 1px solid rgba(99,102,241,0.2);">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">AnÃ¡lise Multi-PerÃ­odo</div>
                        ...
                        ${analysis.mtfAnalysis.timeframes.map(tf => `
                            <div style="background: var(--bg-tertiary); padding: 8px; border-radius: 8px; text-align: center; border-top: 2px solid ${tf.trend === 'BULLISH' ? '#22c55e' : tf.trend === 'BEARISH' ? '#ef4444' : tf.trend === 'WEAK_BULL' ? '#86efac' : tf.trend === 'WEAK_BEAR' ? '#fca5a5' : '#64748b'};">
                                ...
                                <div style="font-size: 13px; font-weight: 800; margin: 4px 0; color: ${tf.trend.includes('BULL') ? '#22c55e' : tf.trend.includes('BEAR') ? '#ef4444' : 'var(--text-secondary)'};">
                                    ${tf.trend.includes('BULL') ? 'Ã¢âÂ²' : tf.trend.includes('BEAR') ? 'â¼' : 'Ã¢ââ¬'}
                                </div>
                ...
                <div class="ta-section" style="border: 1px solid rgba(14,165,233,0.2);">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, #0ea5e9 0%, #0284c7 100%);">
                            <span style="font-size: 18px;">Ã°Å¸âÅ</span>
                        </div>
                        <div>
                            <div class="ta-section-title">HistÃ³rico deste Setup</div>
                            <div class="ta-section-subtitle">${analysis.setupStats.count} ocorrÃªncias registradas</div>
                        </div>
                    </div>
                    <div style="padding: 14px; background: ${analysis.setupStats.quality === 'EXCELENTE' ? 'rgba(34,197,94,0.06)' : analysis.setupStats.quality === 'BOM' ? 'rgba(59,130,246,0.06)' : analysis.setupStats.quality === 'MÃDIO' ? 'rgba(245,158,11,0.06)' : 'rgba(239,68,68,0.06)'}; border-radius: 12px; border: 1px solid ${analysis.setupStats.quality === 'EXCELENTE' ? 'rgba(34,197,94,0.2)' : analysis.setupStats.quality === 'BOM' ? 'rgba(59,130,246,0.2)' : analysis.setupStats.quality === 'MÃDIO' ? 'rgba(245,158,11,0.2)' : 'rgba(239,68,68,0.2)'};">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                            <span style="font-size: 14px; font-weight: 800; color: ${analysis.setupStats.quality === 'EXCELENTE' ? '#22c55e' : analysis.setupStats.quality === 'BOM' ? '#3b82f6' : analysis.setupStats.quality === 'MÃDIO' ? '#f59e0b' : '#ef4444'};">
                                ${analysis.setupStats.quality === 'EXCELENTE' ? 'Ã°Å¸Ââ ' : analysis.setupStats.quality === 'BOM' ? 'Ã°Å¸âÂ' : analysis.setupStats.quality === 'MÃDIO' ? 'Ã°Å¸Â¤â' : 'Ã¢Å¡Â Ã¯Â¸Â'} ${analysis.setupStats.quality}
                            </span>
                            <span style="font-size: 10px; color: var(--text-muted);">${analysis.setupStats.count} ocorrÃªncias</span>
                        </div>
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px;">
                        ...
                        <div style="margin-top: 8px; padding: 6px 10px; background: rgba(245,158,11,0.1); border-radius: 6px; font-size: 10px; color: #f59e0b; text-align: center;">
                            Ã¢Å¡Â Ã¯Â¸Â Amostra pequena â dados estatisticamente insuficientes
                        </div>
                        ` : ''}
                    </div>
                </div>
                ...
                <div class="ta-section" style="border: 1px solid ${analysis.marketBreadth.alignment === 'STRONG_ALIGNED' ? 'rgba(34,197,94,0.3)' : analysis.marketBreadth.alignment === 'DIVERGING' ? 'rgba(239,68,68,0.3)' : 'rgba(100,116,139,0.2)'};">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%);">
                            <span style="font-size: 18px;">Ã°Å¸ÅÂ</span>
                        </div>
                        <div>
                            <div class="ta-section-title">Sentimento do Mercado</div>
                            <div class="ta-section-subtitle">AnÃ¡lise geral do mercado â ${analysis.marketBreadth.totalAssets} ativos analisados</div>
                        </div>
                    </div>
                    <div style="padding: 14px; border-radius: 12px; background: var(--bg-tertiary);">
                        ...
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            <span style="font-size: 11px; color: #22c55e; font-weight: 700;">Ã°Å¸Å¸Â¢ Long ${analysis.marketBreadth.longPct}%</span>
                            <span style="font-size: 11px; color: #64748b; font-weight: 600;">Neutro ${analysis.marketBreadth.neutralPct}%</span>
                            <span style="font-size: 11px; color: #ef4444; font-weight: 700;">Ã°Å¸âÂ´ Short ${analysis.marketBreadth.shortPct}%</span>
                        </div>
                ...
                <div class="ta-section" style="border: 1px solid ${indicators.pineV7.active ? (indicators.pineV7.direction === 'LONG' ? 'rgba(34,197,94,0.35)' : 'rgba(239,68,68,0.35)') : 'rgba(148,163,184,0.2)'}; ${indicators.pineV7.active ? 'box-shadow: 0 0 20px ' + (indicators.pineV7.direction === 'LONG' ? 'rgba(34,197,94,0.08)' : 'rgba(239,68,68,0.08)') + ';' : ''}">
                    <div class="ta-section-header">
                        ...
                        <div>
                            ...
                            <div class="ta-section-subtitle">BTC PRO v7 â Stops Inteligentes</div>
                        </div>
                    </div>
                    <div style="padding: 14px; background: var(--bg-tertiary); border-radius: 12px;">
                        ...
                        <div style="margin-bottom: 10px;">
                            ...
                            <div style="display: flex; justify-content: space-between; margin-top: 4px; font-size: 9px; color: var(--text-muted);">
                                <span>0</span>
                                <span style="color: ${indicators.pineV7.score >= 90 ? '#22c55e' : indicators.pineV7.score >= 75 ? '#f59e0b' : '#94a3b8'}; font-weight: 700;">${indicators.pineV7.score >= 90 ? 'Ã°Å¸Å¸Â¢ Alta Assertividade' : indicators.pineV7.score >= 75 ? 'Ã°Å¸Å¸Â¡ Assertividade Moderada' : 'âª Sem Setup'}</span>
                                <span>100</span>
                            </div>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 6px; margin-bottom: 10px;">
                            ...
                            <div style="background: var(--bg-card); padding: 8px; border-radius: 8px; text-align: center;">
                                <div style="font-size: 8px; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">ConfluÃªncia</div>
                                <div style="font-size: 14px; font-weight: 800; color: ${indicators.pineV7.active ? (indicators.pineV7.direction === 'LONG' ? '#22c55e' : '#ef4444') : 'var(--text-muted)'};">${indicators.pineV7.active ? (indicators.pineV7.confidenceBoost > 0 ? '+' + indicators.pineV7.confidenceBoost + '%' : '0%') : 'â'}</div>
                            </div>
                        </div>
                        ...
                        <div style="display: flex; gap: 4px; flex-wrap: wrap;">
                            <span style="font-size: 10px; padding: 3px 8px; border-radius: 6px; background: ${(indicators.pineV7.components.alta || indicators.pineV7.components.baixa) ? (indicators.pineV7.components.alta ? 'rgba(34,197,94,0.15)' : 'rgba(239,68,68,0.15)') : 'rgba(148,163,184,0.1)'}; color: ${(indicators.pineV7.components.alta || indicators.pineV7.components.baixa) ? (indicators.pineV7.components.alta ? '#4ade80' : '#f87171') : 'var(--text-muted)'};">
                                ${indicators.pineV7.components.alta ? 'Ã¢âÂ² EMAs Alta' : indicators.pineV7.components.baixa ? 'â¼ EMAs Baixa' : 'Ã¢ââ¬ Lateral'}
                            </span>
                            <span style="font-size: 10px; padding: 3px 8px; border-radius: 6px; background: ${indicators.pineV7.components.forca ? 'rgba(59,130,246,0.15)' : 'rgba(148,163,184,0.1)'}; color: ${indicators.pineV7.components.forca ? '#60a5fa' : 'var(--text-muted)'};">
                                ${indicators.pineV7.components.forca ? 'Ã°Å¸âÂª ForÃ§a (ADX>' : 'ð´ Fraco (ADX<'}20)
                            </span>
                            <span style="font-size: 10px; padding: 3px 8px; border-radius: 6px; background: ${(indicators.pineV7.components.pullbackCompra || indicators.pineV7.components.pullbackVenda) ? 'rgba(168,85,247,0.15)' : 'rgba(148,163,184,0.1)'}; color: ${(indicators.pineV7.components.pullbackCompra || indicators.pineV7.components.pullbackVenda) ? '#c084fc' : 'var(--text-muted)'};">
                                ${(indicators.pineV7.components.pullbackCompra || indicators.pineV7.components.pullbackVenda) ? 'â No Pullback' : 'Ã¢Åâ Longe das EMAs'}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            ...
                            <div class="ta-section-subtitle">ClassificaÃ§Ã£o baseada em ADX + Volume + Bollinger</div>
                        </div>
                    </div>
                    <div style="padding: 16px; background: linear-gradient(135deg, ${marketRegime.regimeColor}15 0%, transparent 100%); border-radius: 12px; border: 1px solid ${marketRegime.regimeColor}30;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            ...
                            <div style="text-align: right;">
                                <div style="font-size: 10px; color: var(--text-muted);">ForÃ§a</div>
                        ...
                        <div style="padding: 10px; background: rgba(139, 92, 246, 0.15); border: 1px solid rgba(139, 92, 246, 0.3); border-radius: 8px; margin-bottom: 8px;">
                            <div style="font-size: 12px; font-weight: 700; color: #8b5cf6;">ð BOLLINGER SQUEEZE DETECTADO</div>
                            <div style="font-size: 10px; color: var(--text-muted); margin-top: 2px;">Volatilidade comprimida â explosÃ£o de preÃ§o iminente</div>
                        </div>
                        ` : ''}
                        <div style="padding: 10px; background: var(--bg-tertiary); border-radius: 8px;">
                            <div style="font-size: 11px; color: var(--text-muted);">Ã°Å¸âÂ¡ ImplicaÃ§Ã£o:</div>
                    ...
                    <div style="padding: 16px; background: var(--bg-tertiary); border-radius: 12px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            <div style="font-size: 16px; font-weight: 800; white-space: nowrap; color: ${marketStructure.overallStructure === 'BULLISH' ? '#22c55e' : marketStructure.overallStructure === 'BEARISH' ? '#ef4444' : '#94a3b8'};">
                                ${marketStructure.overallStructure === 'BULLISH' ? 'Ã¢âÂ²' : marketStructure.overallStructure === 'BEARISH' ? 'â¼' : 'âï¸'} ${marketStructure.overallStructure}
                            </div>
                        ...
                        <div style="margin-top: 10px; padding: 10px; background: ${marketStructure.liquiditySweeps.type === 'SWEEP_LOWS' ? 'rgba(34,197,94,0.15)' : 'rgba(239,68,68,0.15)'}; border-radius: 8px; border: 1px solid ${marketStructure.liquiditySweeps.type === 'SWEEP_LOWS' ? 'rgba(34,197,94,0.3)' : 'rgba(239,68,68,0.3)'};">
                            <div style="font-size: 12px; font-weight: 700; color: ${marketStructure.liquiditySweeps.type === 'SWEEP_LOWS' ? '#22c55e' : '#ef4444'};">
                                Ã°Å¸Å½Â¯ LIQUIDITY SWEEP DETECTADO
                            </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">CVD AvanÃ§ado</div>
                            <div class="ta-section-subtitle">DivergÃªncias, AbsorÃ§Ã£o, Breakouts</div>
                        </div>
                    </div>
                    <div style="padding: 16px; background: var(--bg-tertiary); border-radius: 12px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px;">
                            <div style="padding: 8px; background: ${cvdAdvanced.divergence ? (cvdAdvanced.divergence.type.includes('BULLISH') ? 'rgba(34,197,94,0.15)' : 'rgba(239,68,68,0.15)') : 'var(--bg-card)'}; border-radius: 8px; text-align: center;">
                                <div style="font-size: 9px; color: var(--text-muted); white-space: nowrap;">DivergÃªncia</div>
                                <div style="font-size: 14px;">${cvdAdvanced.divergence ? cvdAdvanced.divergence.icon : 'â'}</div>
                            ...
                            <div style="padding: 8px; background: ${cvdAdvanced.absorption ? 'rgba(139,92,246,0.15)' : 'var(--bg-card)'}; border-radius: 8px; text-align: center;">
                                <div style="font-size: 9px; color: var(--text-muted); white-space: nowrap;">AbsorÃ§Ã£o</div>
                                <div style="font-size: 14px;">${cvdAdvanced.absorption ? 'Ã°Å¸Ââ¹' : 'â'}</div>
                            ...
                            <div style="padding: 8px; background: ${cvdAdvanced.breakout ? 'rgba(249,115,22,0.15)' : 'var(--bg-card)'}; border-radius: 8px; text-align: center;">
                                ...
                                <div style="font-size: 14px;">${cvdAdvanced.breakout ? 'Ã°Å¸âÂ¥' : 'â'}</div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">NotÃ­cias Urgentes</div>
                            <div class="ta-section-subtitle">Alertas de alto impacto e notÃ­cias relevantes</div>
                        </div>
                    </div>
                    <div style="padding: 16px; background: var(--bg-tertiary); border-radius: 12px;">
                        <!-- Macro Sentiment -->
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            <div>
                                <div style="font-size: 14px; font-weight: 700; color: ${macroNews.macroColor}; white-space: nowrap;">
                                    ${macroNews.macroSentiment === 'BULLISH' ? 'Ã°Å¸Å¸Â¢' : macroNews.macroSentiment === 'BEARISH' ? 'Ã°Å¸âÂ´' : macroNews.macroSentiment === 'CAUTELA' ? 'Ã°Å¸Å¸Â¡' : 'âª'} 
                        ...
                        <div style="margin-bottom: 12px;">
                            <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 8px; text-transform: uppercase;">Ã°Å¸ââ¦ PrÃ³ximos Eventos de Alto Impacto</div>
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 8px; background: var(--bg-card); border-radius: 6px; margin-bottom: 4px; border-left: 3px solid ${e.isCritical ? '#ef4444' : '#f59e0b'}; gap: 6px;">
                                <div style="min-width: 0; flex: 1; overflow: hidden;">
                                    ...
                                    <div style="font-size: 9px; color: var(--text-muted); white-space: nowrap;">${e.country || ''} Ã¢â¬Â¢ ${new Date(e.date).toLocaleDateString('pt-BR', { day: '2-digit', month: '2-digit', hour: '2-digit', minute: '2-digit' })}</div>
                                </div>
                                <span style="font-size: 9px; padding: 2px 6px; background: ${e.isCritical ? 'rgba(239,68,68,0.2)' : 'rgba(245,158,11,0.2)'}; color: ${e.isCritical ? '#ef4444' : '#f59e0b'}; border-radius: 4px; font-weight: 600; white-space: nowrap; flex-shrink: 0;">${e.isCritical ? 'CRÃÂTICO' : 'ALTO'}</span>
                            </div>
                            `).join('')}
                        </div>
                        ` : ''}
                        ...
                        <div>
                            <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 8px; text-transform: uppercase;">Ã°Å¸âÂ° NotÃ­cias de Alto Impacto</div>
                            ...
                            <div style="padding: 8px; background: var(--bg-card); border-radius: 6px; margin-bottom: 4px; border-left: 3px solid ${n.sentiment > 0 ? '#22c55e' : n.sentiment < 0 ? '#ef4444' : '#94a3b8'};">
                                <div style="font-size: 11px; color: var(--text-primary); line-height: 1.3;">${n.isUrgent ? 'Ã°Å¸Å¡Â¨ ' : ''}${n.title?.substring(0, 80)}</div>
                                <div style="font-size: 9px; color: var(--text-muted); margin-top: 4px;">${n.source} Ã¢â¬Â¢ ${n.sentiment > 0 ? 'Ã°Å¸Å¸Â¢ Bullish' : n.sentiment < 0 ? 'Ã°Å¸âÂ´ Bearish' : 'âª Neutro'}</div>
                            </div>
                            `).join('')}
                        </div>
                        ` : `
                        <div style="text-align: center; padding: 12px; color: var(--text-muted); font-size: 11px;">
                            Ã¢Åâ¦ Nenhuma notÃ­cia urgente detectada
                        </div>
                        `}
                    </div>
                </div>
                ...
                <div class="ta-section">
                    ...
                    <div style="padding: 12px; background: var(--bg-tertiary); border-radius: 12px; overflow: hidden;">
                        ...
                        <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 10px; text-transform: uppercase;">Ã°Å¸ÂÂ¢ Big Tech â Resultados em Tempo Real</div>
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 6px; margin-bottom: 16px;">
                            ...
                            <div style="background: var(--bg-card); border-radius: 10px; padding: 10px 6px; text-align: center; border: 1px solid ${t.changePercent > 0 ? 'rgba(34,197,94,0.2)' : t.changePercent < 0 ? 'rgba(239,68,68,0.2)' : 'var(--border-subtle)'};">
                                ...
                                <div style="font-size: 11px; font-weight: 700; white-space: nowrap; color: ${t.changePercent > 0 ? '#22c55e' : t.changePercent < 0 ? '#ef4444' : '#94a3b8'};">
                                    ${t.changePercent > 0 ? 'Ã¢âÂ²' : t.changePercent < 0 ? 'â¼' : 'Ã¢â¬â'} ${Math.abs(t.changePercent || 0).toFixed(2)}%
                                </div>
                            </div>
                            `).join('')}
                        </div>
                        ...
                        <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 10px; text-transform: uppercase;">ð ÃÂndices de Mercado</div>
                        ...
                        <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 10px; text-transform: uppercase;">Ã°Å¸Å½Â­ Fear & Greed Index</div>
                        ...
                        <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 10px; text-transform: uppercase;">Ã°Å¸ÂâºÃ¯Â¸Â Treasury Yields (TÃ­tulos do Tesouro EUA)</div>
                        ...
                        <div style="padding: 8px 12px; background: rgba(239,68,68,0.12); border: 1px solid rgba(239,68,68,0.25); border-radius: 8px; margin-bottom: 16px;">
                            <div style="font-size: 11px; font-weight: 700; color: #ef4444;">Ã¢Å¡Â Ã¯Â¸Â Curva de Juros INVERTIDA (3M-10Y: ${bigTechMacro.treasuryYields.yieldCurveSpread?.toFixed(2) || '?'}%) â Sinal de recessÃ£o</div>
                        </div>
                        ` : `
                        <div style="padding: 8px 12px; background: rgba(34,197,94,0.08); border-radius: 8px; margin-bottom: 16px;">
                            <div style="font-size: 11px; color: var(--text-muted);">Ã¢Åâ¦ Spread 3M-10Y: ${bigTechMacro.treasuryYields.yieldCurveSpread != null ? bigTechMacro.treasuryYields.yieldCurveSpread.toFixed(2) + '%' : 'N/A'} â Curva normal</div>
                        </div>
                        `}
                        ` : ''}
                        ...
                        <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 10px; text-transform: uppercase;">Ã°Å¸â¡ÂºÃ°Å¸â¡Â¸ Indicadores MacroeconÃÂ´micos dos EUA</div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            ...
                            <div class="ta-section-subtitle">Fluxo de ordens e intenÃ§Ã£o institucional</div>
                        </div>
                    </div>
                    ...
                    <div style="background: var(--bg-tertiary); border-radius: 12px; padding: 16px; margin-bottom: 16px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            <div style="font-size: 14px; font-weight: 700; color: var(--text-primary);">ð Funding Rate</div>
                        ...
                        <div style="margin-top: 12px; padding: 10px; background: ${parseFloat(indicators.orderFlow.fundingRate) > 0.03 ? 'rgba(239, 68, 68, 0.15)' : parseFloat(indicators.orderFlow.fundingRate) < -0.01 ? 'rgba(34, 197, 94, 0.15)' : 'rgba(245, 158, 11, 0.15)'}; border-radius: 8px;">
                            <div style="font-size: 11px; font-weight: 600; color: ${parseFloat(indicators.orderFlow.fundingRate) > 0.03 ? '#ef4444' : parseFloat(indicators.orderFlow.fundingRate) < -0.01 ? '#22c55e' : '#f59e0b'};">
                                ${parseFloat(indicators.orderFlow.fundingRate) > 0.05 ? 'Ã¢Å¡Â Ã¯Â¸Â MUITO ALTO - Mercado sobrecomprado, pressÃ£o de venda iminente' : parseFloat(indicators.orderFlow.fundingRate) > 0.03 ? 'Ã¢âÂ² ALTO - Longs dominantes, risco de liquidaÃ§Ã£o cascata' : parseFloat(indicators.orderFlow.fundingRate) > 0.01 ? 'ð LEVEMENTE ALTO - Longs pagando shorts' : parseFloat(indicators.orderFlow.fundingRate) < -0.03 ? 'Ã¢Å¡Â Ã¯Â¸Â MUITO NEGATIVO - Shorts dominantes, possÃ­vel squeeze' : parseFloat(indicators.orderFlow.fundingRate) < -0.01 ? 'â¼ NEGATIVO - Shorts pagando longs' : 'âï¸ NEUTRO - Mercado equilibrado'}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ta-indicator-grid">
                        <div class="ta-indicator-item">
                            ...
                            <div class="ta-indicator-change">${indicators.orderFlow.cvdSignal.includes('absorption') ? 'Ã¢Å¡Â¡ AbsorÃ§Ã£o detectada' : 'Delta de volume'}</div>
                        </div>
                        <div class="ta-indicator-item">
                            <div class="ta-indicator-header">
                                ...
                                <span class="ta-indicator-signal ${indicators.orderFlow.oiSignal === 'increasing' ? 'bullish' : indicators.orderFlow.oiSignal === 'decreasing' ? 'bearish' : 'neutral'}">
                                    ${indicators.orderFlow.oiSignal === 'increasing' ? 'SUBINDO' : indicators.orderFlow.oiSignal === 'decreasing' ? 'CAINDO' : 'ESTÃVEL'}
                                </span>
                            </div>
                            <div class="ta-indicator-value">${indicators.orderFlow.oiChange > 0 ? '+' : ''}${indicators.orderFlow.oiChange}%</div>
                            <div class="ta-indicator-change">VariaÃ§Ã£o de contratos</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            ...
                            <div class="ta-section-subtitle">Mapa de preÃ§o justo (Auction Market Theory)</div>
                        </div>
                    </div>
                    <div class="ta-indicator-grid">
                        <div class="ta-indicator-item">
                        ...
                        <div class="ta-indicator-item">
                            ...
                            <div class="ta-indicator-change">MÃ©dia institucional</div>
                        </div>
                        <div class="ta-indicator-item">
                            <div class="ta-indicator-header">
                            ...
                            <div class="ta-indicator-change">Ãrea de valor alta</div>
                        </div>
                        <div class="ta-indicator-item">
                            <div class="ta-indicator-header">
                            ...
                            <div class="ta-indicator-change">Ãrea de valor baixa</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            ...
                            <div class="ta-section-subtitle">Filtros de confluÃªncia tÃ©cnica</div>
                        </div>
                    </div>
                    <div class="ta-indicator-grid">
                        <div class="ta-indicator-item">
                            ...
                            <div class="ta-indicator-change">${parseFloat(indicators.sentiment.rsi) < 30 ? 'Ã¢Å¡Â¡ Oportunidade' : parseFloat(indicators.sentiment.rsi) > 70 ? 'Ã¢Å¡Â Ã¯Â¸Â Cuidado' : 'Normal'}</div>
                        </div>
                        <div class="ta-indicator-item">
                            <div class="ta-indicator-header">
                            ...
                            <div class="ta-indicator-change">${parseFloat(indicators.sentiment.takerRatio) > 1 ? 'Ã°Å¸Å¸Â¢ PressÃ£o compradora' : parseFloat(indicators.sentiment.takerRatio) < 1 ? 'Ã°Å¸âÂ´ PressÃ£o vendedora' : 'Equilibrado'}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">MÃ©dias MÃ³veis</div>
                    ...
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 6px; margin-top: 10px;">
                        <div style="background: linear-gradient(135deg, rgba(59, 130, 246, 0.15) 0%, transparent 100%); padding: 10px 8px; border-radius: 10px; border: 1px solid rgba(59, 130, 246, 0.3); text-align: center; min-width: 0; overflow: hidden;">
                            ...
                            <div style="font-size: 9px; color: ${parseFloat(indicators.movingAverages?.currentPrice || 0) > parseFloat(indicators.movingAverages?.ema9 || 0) ? '#22c55e' : '#ef4444'}; margin-top: 2px;">
                                ${parseFloat(indicators.movingAverages?.currentPrice || 0) > parseFloat(indicators.movingAverages?.ema9 || 0) ? 'Ã¢âÂ² Acima' : 'â¼ Abaixo'}
                            </div>
                        </div>
                        <div style="background: linear-gradient(135deg, rgba(34, 197, 94, 0.15) 0%, transparent 100%); padding: 10px 8px; border-radius: 10px; border: 1px solid rgba(34, 197, 94, 0.3); text-align: center; min-width: 0; overflow: hidden;">
                            ...
                            <div style="font-size: 9px; color: ${parseFloat(indicators.movingAverages?.currentPrice || 0) > parseFloat(indicators.movingAverages?.ema21 || 0) ? '#22c55e' : '#ef4444'}; margin-top: 2px;">
                                ${parseFloat(indicators.movingAverages?.currentPrice || 0) > parseFloat(indicators.movingAverages?.ema21 || 0) ? 'Ã¢âÂ² Acima' : 'â¼ Abaixo'}
                            </div>
                        </div>
                        <div style="background: linear-gradient(135deg, rgba(249, 115, 22, 0.15) 0%, transparent 100%); padding: 10px 8px; border-radius: 10px; border: 1px solid rgba(249, 115, 22, 0.3); text-align: center; min-width: 0; overflow: hidden;">
                            ...
                            <div style="font-size: 9px; color: ${parseFloat(indicators.movingAverages?.currentPrice || 0) > parseFloat(indicators.movingAverages?.ema50 || 0) ? '#22c55e' : '#ef4444'}; margin-top: 2px;">
                                ${parseFloat(indicators.movingAverages?.currentPrice || 0) > parseFloat(indicators.movingAverages?.ema50 || 0) ? 'Ã¢âÂ² Acima' : 'â¼ Abaixo'}
                            </div>
                        </div>
                        <div style="background: var(--bg-tertiary); padding: 10px 8px; border-radius: 10px; text-align: center; min-width: 0; overflow: hidden;">
                            ...
                            <div style="font-size: 9px; color: ${parseFloat(indicators.movingAverages?.currentPrice || 0) > parseFloat(indicators.movingAverages?.sma50 || 0) ? '#22c55e' : '#ef4444'}; margin-top: 2px;">
                                ${parseFloat(indicators.movingAverages?.currentPrice || 0) > parseFloat(indicators.movingAverages?.sma50 || 0) ? 'Ã¢âÂ² Acima' : 'â¼ Abaixo'}
                            </div>
                        </div>
                        <div style="background: var(--bg-tertiary); padding: 10px 8px; border-radius: 10px; text-align: center; min-width: 0; overflow: hidden;">
                            ...
                            <div style="font-size: 9px; color: ${parseFloat(indicators.movingAverages?.currentPrice || 0) > parseFloat(indicators.movingAverages?.sma99 || 0) ? '#22c55e' : '#ef4444'}; margin-top: 2px;">
                                ${parseFloat(indicators.movingAverages?.currentPrice || 0) > parseFloat(indicators.movingAverages?.sma99 || 0) ? 'Ã¢âÂ² Acima' : 'â¼ Abaixo'}
                            </div>
                        </div>
                        <div style="background: var(--bg-tertiary); padding: 10px 8px; border-radius: 10px; text-align: center; min-width: 0; overflow: hidden;">
                            ...
                            <div style="font-size: 9px; color: ${parseFloat(indicators.movingAverages?.currentPrice || 0) > parseFloat(indicators.movingAverages?.sma200 || 0) ? '#22c55e' : '#ef4444'}; margin-top: 2px;">
                                ${parseFloat(indicators.movingAverages?.currentPrice || 0) > parseFloat(indicators.movingAverages?.sma200 || 0) ? 'Ã¢âÂ² Acima' : 'â¼ Abaixo'}
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="margin-top: 12px; padding: 12px; background: var(--bg-tertiary); border-radius: 10px;">
                        <div style="font-size: 11px; font-weight: 700; color: var(--accent-purple); margin-bottom: 8px;">
                            <i class="fas fa-layer-group" style="margin-right: 6px;"></i>Suporte & ResistÃªncia
                        </div>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                            ...
                            <div style="background: var(--bg-card); padding: 10px; border-radius: 8px; border-left: 3px solid #ef4444;">
                                <div style="font-size: 10px; color: var(--text-muted);">RESISTÃÅ NCIA</div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">Alertas & LimitaÃ§Ãµes</div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, #ef4444 0%, #991b1b 100%);">
                            <span style="font-size: 18px;">${analysis.crashState.override.icon || 'Ã°Å¸Å¡Â¨'}</span>
                        </div>
                        <div>
                            <div class="ta-section-title">Detector de Crash/Pump</div>
                            <div class="ta-section-subtitle">ProteÃ§Ã£o contra Black Swan</div>
                        </div>
                    </div>
                    <div style="padding: 16px; background: ${analysis.crashState.isCrash || analysis.crashState.isRapidPump ? 'rgba(239,68,68,0.1)' : 'rgba(234,179,8,0.1)'}; border-radius: 12px; border: 1px solid ${analysis.crashState.isCrash || analysis.crashState.isRapidPump ? 'rgba(239,68,68,0.3)' : 'rgba(234,179,8,0.3)'};">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                            ...
                            <span style="font-size: 11px; white-space: nowrap; color: var(--text-muted);">DireÃ§Ã£o: ${analysis.crashState.direction === 'down' ? 'Ã¢â â Queda' : 'Ã¢â â Alta'}</span>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 8px;">
                            ...
                            <div style="background: var(--bg-tertiary); padding: 8px; border-radius: 8px; text-align: center;">
                                ...
                                <div style="font-size: 13px; font-weight: 700; color: ${analysis.crashState.volumeSpikeDetected ? '#ef4444' : '#94a3b8'};">${analysis.crashState.volumeSpikeDetected ? 'SIM' : 'NÃO'}</div>
                            </div>
                        </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, #0ea5e9 0%, #0369a1 100%);">
                            <span style="font-size: 18px;">Ã°Å¸âÂ°</span>
                        </div>
                        <div>
                            <div class="ta-section-title">GestÃ£o de Risco & PosiÃ§Ã£o</div>
                            <div class="ta-section-subtitle">Quanto arriscar nesta operaÃ§Ã£o</div>
                        </div>
                    </div>
                    <div style="padding: 16px; background: rgba(14,165,233,0.08); border-radius: 12px; border: 1px solid rgba(14,165,233,0.2);">
                        ...
                        <div style="text-align: center; margin-bottom: 14px;">
                            ...
                            <div style="display: inline-block; margin-top: 8px; padding: 4px 12px; border-radius: 8px; background: ${analysis.positionSize.riskLevel === 'CONSERVADOR' ? 'rgba(34,197,94,0.2)' : analysis.positionSize.riskLevel === 'MODERADO' ? 'rgba(234,179,8,0.2)' : 'rgba(239,68,68,0.2)'}; color: ${analysis.positionSize.riskLevel === 'CONSERVADOR' ? '#22c55e' : analysis.positionSize.riskLevel === 'MODERADO' ? '#eab308' : '#ef4444'}; font-size: 10px; font-weight: 700;">
                                ${analysis.positionSize.riskLevel === 'CONSERVADOR' ? 'Ã°Å¸âºÂ¡Ã¯Â¸Â Risco Baixo' : analysis.positionSize.riskLevel === 'MODERADO' ? 'âï¸ Risco MÃ©dio' : analysis.positionSize.riskLevel === 'AGRESSIVO' ? 'Ã°Å¸âÂ¥ Risco Alto' : 'Ã¢Å¡Â Ã¯Â¸Â Risco MÃ¡ximo'}
                            </div>
                        </div>
                        ...
                        <div style="display: flex; flex-direction: column; gap: 6px;">
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px; background: var(--bg-tertiary); border-radius: 8px;">
                                <span style="font-size: 11px; color: var(--text-muted);">ð O que significa</span>
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px; background: var(--bg-tertiary); border-radius: 8px;">
                                <span style="font-size: 11px; color: var(--text-muted);">ð ConfianÃ§a do sinal</span>
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px; background: var(--bg-tertiary); border-radius: 8px;">
                                <span style="font-size: 11px; color: var(--text-muted);">ð¡ï¸Â Volatilidade (ATR)</span>
                            ...
                            <div style="padding: 10px; background: rgba(239,68,68,0.1); border-radius: 8px; border: 1px solid rgba(239,68,68,0.2);">
                                <span style="font-size: 11px; color: #ef4444; font-weight: 600;">Ã¢Å¡Â Ã¯Â¸Â Mercado em queda detectado â posiÃ§Ã£o reduzida automaticamente</span>
                            </div>
                            ` : ''}
                        </div>
                        <div style="margin-top: 10px; padding: 10px; background: rgba(14,165,233,0.06); border-radius: 8px; border: 1px dashed rgba(14,165,233,0.2);">
                            <div style="font-size: 10px; color: var(--text-muted); text-align: center; line-height: 1.5;">
                                Ã°Å¸âÂ¡ <strong>Dica:</strong> Se vocÃª tem R$ 1.000, use no mÃ¡ximo R$ ${(10 * analysis.positionSize.sizePercent).toFixed(0)} nesta operaÃ§Ã£o.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%);">
                            <span style="font-size: 18px;">Ã¢âºâÃ¯Â¸Â</span>
                        </div>
                        <div>
                            <div class="ta-section-title">AnÃ¡lise On-Chain</div>
                ...
                <!-- CONFIRMAÃâ¡Ãâ¢ES DE ANÃLISE -->
                <!-- Ã¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢ÂÃ¢â¢Â -->
                ...
                <div class="ta-section" style="border: 1px solid rgba(249,115,22,0.3); background: linear-gradient(135deg, rgba(249,115,22,0.05) 0%, transparent 100%);">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">ConfirmaÃ§Ãµes</div>
                            <div class="ta-section-subtitle">Reagir ao mercado, nÃ£o antecipar â ${analysis.v4GatesPassed || 0}/${analysis.v4GatesTotal || 9} confirmaÃ§Ãµes</div>
                        </div>
                    </div>
                    <div style="margin-bottom: 10px; padding: 10px; border-radius: 8px; background: rgba(249,115,22,0.08); border: 1px solid rgba(249,115,22,0.15);">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                            <span style="font-size: 12px; font-weight: 700; color: #fb923c; white-space: nowrap;">Score de ConfirmaÃ§Ã£o</span>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 6px;">
                        ${analysis.v4Gates.map(g => `
                            <div style="display: flex; align-items: flex-start; gap: 8px; padding: 8px 10px; background: ${g.passed ? 'rgba(34,197,94,0.06)' : 'rgba(239,68,68,0.06)'}; border-radius: 8px; border-left: 3px solid ${g.passed ? '#22c55e' : '#ef4444'};">
                                <span style="font-size: 14px; min-width: 20px;">${g.passed ? 'Ã¢Åâ¦' : 'Ã¢ÂÅ'}</span>
                                <div style="flex: 1;">
                                    <div style="font-size: 11px; font-weight: 700; color: var(--text-primary); white-space: nowrap;">${g.name}</div>
                                    <div style="font-size: 10px; color: var(--text-secondary); margin-top: 2px; line-height: 1.3;">${(g.description || '').replace(/^[Ã¢Åâ¦Ã¢ÂÅÃ¢Å¡Â Ã¯Â¸Â]\s?/, '')}</div>
                                </div>
                            </div>
                        `).join('')}
                    </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%);">
                            <span style="font-size: 18px;">Ã¢Å¡Â¡</span>
                        </div>
                        <div>
                            <div class="ta-section-title">ForÃ§a do Movimento</div>
                            <div class="ta-section-subtitle">Intensidade e volume do Ãºltimo movimento</div>
                        </div>
                    </div>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-bottom: 8px;">
                        ...
                        <div style="padding: 10px; background: ${analysis.volumeExpansion?.expanding ? 'rgba(34,197,94,0.1)' : 'rgba(100,116,139,0.1)'}; border-radius: 8px; border: 1px solid ${analysis.volumeExpansion?.expanding ? 'rgba(34,197,94,0.2)' : 'rgba(100,116,139,0.15)'};">
                            ...
                            <div style="font-size: 10px; color: var(--text-secondary); margin-top: 2px;">Intensidade: ${analysis.volumeExpansion?.volZScore != null ? analysis.volumeExpansion.volZScore.toFixed(2) : (analysis.volumeExpansion?.['1h']?.ratio || '?') + 'Ãâ mÃ©dia'}${analysis.volumeExpansion?.sustained ? ' (sustentado)' : ''}</div>
                        </div>
                    </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">PosiÃ§Ã£o no Range</div>
                            <div class="ta-section-subtitle">AnÃ¡lise de posiÃ§Ã£o relativa do preÃ§o</div>
                        </div>
                    </div>
                    <div style="padding: 12px; background: ${analysis.rangePosition.tradeable ? 'rgba(34,197,94,0.08)' : 'rgba(239,68,68,0.08)'}; border-radius: 10px; border: 1px solid ${analysis.rangePosition.tradeable ? 'rgba(34,197,94,0.2)' : 'rgba(239,68,68,0.2)'}; margin-bottom: 8px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
                            ...
                            <span style="font-size: 10px; padding: 3px 8px; border-radius: 4px; font-weight: 700; white-space: nowrap; background: ${analysis.rangePosition.tradeable ? 'rgba(34,197,94,0.2)' : 'rgba(239,68,68,0.2)'}; color: ${analysis.rangePosition.tradeable ? '#22c55e' : '#ef4444'};">${analysis.rangePosition.tradeable ? 'OPERÃVEL' : 'BLOQUEADO'}</span>
                        </div>
                    ...
                    <div style="padding: 8px 10px; background: rgba(34,197,94,0.1); border-radius: 8px; margin-top: 6px; border: 1px solid rgba(34,197,94,0.2);">
                        <div style="font-size: 11px; font-weight: 700; color: #22c55e;">Ã¢Åâ¦ ${analysis.retest.details}</div>
                ...
                <div class="ta-section" style="border: 1px solid ${analysis.sessionContext.session === 'KILL_ZONE' ? 'rgba(239,68,68,0.3)' : analysis.sessionContext.session === 'LONDON_OPEN' ? 'rgba(59,130,246,0.3)' : 'rgba(100,116,139,0.2)'}; background: linear-gradient(135deg, ${analysis.sessionContext.session === 'KILL_ZONE' ? 'rgba(239,68,68,0.05)' : analysis.sessionContext.session === 'LONDON_OPEN' ? 'rgba(59,130,246,0.05)' : 'rgba(100,116,139,0.03)'} 0%, transparent 100%);">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, ${analysis.sessionContext.session === 'KILL_ZONE' ? '#ef4444, #dc2626' : analysis.sessionContext.session === 'LONDON_OPEN' ? '#3b82f6, #2563eb' : '#64748b, #475569'});">
                            <span style="font-size: 18px;">${analysis.sessionContext.session === 'KILL_ZONE' ? 'Ã°Å¸âÂ¥' : analysis.sessionContext.session === 'LONDON_OPEN' ? 'Ã°Å¸â¡Â¬Ã°Å¸â¡Â§' : analysis.sessionContext.session === 'ASIAN' ? 'Ã°Å¸ÅÂ' : analysis.sessionContext.isWeekend ? 'Ã°Å¸Å¡Â«' : 'Ã°Å¸â¢Â'}</span>
                        </div>
                        <div>
                            <div class="ta-section-title">SessÃ£o: ${analysis.sessionContext.session === 'KILL_ZONE' ? 'Zona de Volatilidade' : analysis.sessionContext.session === 'LONDON_OPEN' ? 'Abertura Londres' : analysis.sessionContext.session === 'ASIAN' ? 'SessÃ£o AsiÃ¡tica' : analysis.sessionContext.session === 'NY_OPEN' ? 'Abertura Nova York' : analysis.sessionContext.session || 'N/A'}</div>
                            <div class="ta-section-subtitle">${analysis.sessionContext.description || 'Contexto de sessÃ£o'}</div>
                        </div>
                    </div>
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px;">
                        <div style="padding: 8px; background: var(--bg-primary); border-radius: 8px; text-align: center;">
                            ...
                            <div style="font-size: 14px; font-weight: 800; color: ${analysis.sessionContext.signalMultiplier >= 1.2 ? '#22c55e' : analysis.sessionContext.signalMultiplier >= 0.8 ? '#f59e0b' : '#ef4444'};">Ãâ${(analysis.sessionContext.signalMultiplier || 1).toFixed(1)}</div>
                        </div>
                        <div style="padding: 8px; background: var(--bg-primary); border-radius: 8px; text-align: center;">
                            <div style="font-size: 9px; color: var(--text-muted); white-space: nowrap;">Liquidez</div>
                            <div style="font-size: 12px; font-weight: 700; color: ${analysis.sessionContext.liquidityLevel === 'ALTA' || analysis.sessionContext.liquidityLevel === 'MÃXIMA' ? '#22c55e' : analysis.sessionContext.liquidityLevel === 'BAIXA' ? '#ef4444' : '#f59e0b'}; white-space: nowrap;">${analysis.sessionContext.liquidityLevel || 'N/A'}</div>
                        </div>
                        <div style="padding: 8px; background: var(--bg-primary); border-radius: 8px; text-align: center;">
                            <div style="font-size: 9px; color: var(--text-muted); white-space: nowrap;">Fake Breakout</div>
                            <div style="font-size: 12px; font-weight: 700; color: ${analysis.sessionContext.fakeBreakoutRisk === 'ALTO' ? '#ef4444' : analysis.sessionContext.fakeBreakoutRisk === 'MÃDIO' ? '#f59e0b' : '#22c55e'}; white-space: nowrap;">${analysis.sessionContext.fakeBreakoutRisk || 'N/A'}</div>
                        </div>
                    </div>
                    ...
                    <div style="margin-top: 8px; padding: 8px 10px; background: rgba(239,68,68,0.1); border-radius: 8px; border: 1px solid rgba(239,68,68,0.2);">
                        <div style="font-size: 11px; font-weight: 700; color: #f87171;">Ã°Å¸Å¡Â« FIM DE SEMANA â Todos sinais limitados a AGUARDAR</div>
                    </div>
                    ` : ''}
                </div>
                ` : ''}
                ...
                <div class="ta-section" style="border: 1px solid rgba(168,85,247,0.3); background: linear-gradient(135deg, rgba(168,85,247,0.05) 0%, transparent 100%);">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">Plano de ExecuÃ§Ã£o</div>
                            <div class="ta-section-subtitle">${analysis.limitOrder.type === 'LIMIT_ON_RETEST' ? 'Limit Order â aguardar reteste' : 'Market â reteste confirmado'}</div>
                        </div>
                    </div>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-bottom: 8px;">
                        <div style="padding: 10px; background: rgba(168,85,247,0.08); border-radius: 8px;">
                            ...
                            <div style="font-size: 14px; font-weight: 800; color: #a855f7;">${analysis.limitOrder.entry != null ? analysis.limitOrder.entry.toLocaleString('en-US', {maximumFractionDigits: 6}) : 'â'}</div>
                        ...
                        <div style="padding: 10px; background: rgba(239,68,68,0.08); border-radius: 8px;">
                            ...
                            <div style="font-size: 14px; font-weight: 800; color: #ef4444;">${analysis.limitOrder.stopLoss != null ? analysis.limitOrder.stopLoss.toLocaleString('en-US', {maximumFractionDigits: 6}) : 'â'}</div>
                        </div>
                    </div>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px;">
                        <div style="padding: 10px; background: rgba(34,197,94,0.08); border-radius: 8px;">
                            ...
                            <div style="font-size: 14px; font-weight: 800; color: #22c55e;">${analysis.limitOrder.takeProfit1 != null ? analysis.limitOrder.takeProfit1.toLocaleString('en-US', {maximumFractionDigits: 6}) : 'â'}</div>
                        </div>
                        <div style="padding: 10px; background: rgba(34,197,94,0.08); border-radius: 8px;">
                            ...
                            <div style="font-size: 14px; font-weight: 800; color: #16a34a;">${analysis.limitOrder.takeProfit2 != null ? analysis.limitOrder.takeProfit2.toLocaleString('en-US', {maximumFractionDigits: 6}) : 'â'}</div>
                        </div>
                    </div>
                ...
                <div class="ta-section" style="border: 1px solid ${analysis.riskEngine.killSwitchActive ? 'rgba(239,68,68,0.4)' : 'rgba(245,158,11,0.2)'}; background: ${analysis.riskEngine.killSwitchActive ? 'linear-gradient(135deg, rgba(239,68,68,0.08) 0%, transparent 100%)' : 'none'};">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, ${analysis.riskEngine.killSwitchActive ? '#ef4444, #dc2626' : '#f59e0b, #d97706'});">
                            <span style="font-size: 18px;">${analysis.riskEngine.killSwitchActive ? 'Ã°Å¸âºâ' : 'Ã°Å¸âºÂ¡Ã¯Â¸Â'}</span>
                        </div>
                        <div>
                            <div class="ta-section-title">GestÃ£o de Risco</div>
                            <div class="ta-section-subtitle">${analysis.riskEngine.killSwitchActive ? 'Ã¢Å¡Â Ã¯Â¸Â Kill Switch ATIVO â ' + (analysis.riskEngine.killSwitchReason || 'pausa forÃ§ada') : 'GestÃ£o dinÃ¢mica de risco'}</div>
                        </div>
                    </div>
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; min-width: 0;">
                        ...
                        <div style="padding: 8px; background: var(--bg-primary); border-radius: 8px; text-align: center; min-width: 0;">
                            ...
                            <div style="font-size: 14px; font-weight: 800; color: ${(analysis.riskEngine.leverage || 1) > 5 ? '#ef4444' : '#f59e0b'};">${analysis.riskEngine.leverage || 1}Ãâ</div>
                        </div>
                        <div style="padding: 8px; background: var(--bg-primary); border-radius: 8px; text-align: center; min-width: 0;">
                            <div style="font-size: 9px; color: var(--text-muted);">Risco</div>
                            <div style="font-size: 12px; font-weight: 700; color: ${analysis.riskEngine.riskLevel === 'LOW' ? '#22c55e' : analysis.riskEngine.riskLevel === 'MEDIUM' ? '#f59e0b' : '#ef4444'};">${analysis.riskEngine.riskLevel === 'LOW' ? 'Baixo' : analysis.riskEngine.riskLevel === 'MEDIUM' ? 'MÃ©dio' : analysis.riskEngine.riskLevel === 'HIGH' ? 'Alto' : 'N/A'}</div>
                        </div>
                    </div>
                    <div style="margin-top: 8px; display: flex; gap: 8px; min-width: 0;">
                        <div style="flex: 1; padding: 6px 10px; background: var(--bg-tertiary); border-radius: 6px; min-width: 0;">
                            <div style="font-size: 9px; color: var(--text-muted);">DD DiÃ¡rio</div>
                ...
                <div class="ta-section" style="border: 1px solid rgba(100,116,139,0.15);">
                    ...
                    <div style="margin-top: 8px; padding: 8px 10px; background: rgba(239,68,68,0.06); border-radius: 8px; font-size: 11px; color: var(--text-secondary);">
                        Ã°Å¸âÂ¥ LiquidaÃ§Ãµes (1h): <strong>${analysis.oiAnalysis.liquidations.longs} longs</strong> / <strong>${analysis.oiAnalysis.liquidations.shorts} shorts</strong> â Total: <strong>$${(analysis.oiAnalysis.liquidations.totalUSD / 1000).toFixed(0)}K</strong>
                    </div>` : ''}
                </div>
                ...
                <div class="ta-ai-summary">
                    <div class="ta-ai-header">
                        ...
                        <div class="ta-ai-title">RelatÃ³rio da IA <span style="font-size: 9px; color: var(--text-muted); font-weight: 400;">Llama 3.3 70B via Groq</span></div>
                    </div>
                    <div class="ta-ai-text" style="white-space: pre-line;"><span style="color: var(--accent-blue);"><i class="fas fa-spinner fa-spin"></i> Gerando relatÃ³rio com IA (Llama 3.3 70B)...</span></div>
                </div>
                
                <!-- Ã¢Å¡Â Ã¯Â¸Â AVISO LEGAL - BotÃ£o que abre modal -->
                ...
                <div class="ta-last-update">
                    ...
                    <span>ÃÅ¡ltima atualizaÃ§Ã£o: ${new Date(timestamp).toLocaleTimeString('pt-BR')}</span>
                    <span style="margin-left: 8px; color: var(--accent-blue);">Ã¢â¬Â¢ Atualiza a cada 5 min</span>
