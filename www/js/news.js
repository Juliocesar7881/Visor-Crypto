        ...
        async function renderHotNewsList(hotNews) {
            ...
            container.innerHTML = hotNews.map((news, index) => {
                ...
                const thumbHtml = news.image 
                    ? `<div class="news-item-thumb"><img src="${news.image}" alt="" loading="lazy" onerror="this.parentElement.innerHTML='<i class=\\'fas fa-fire\\' style=\\'color:#f97316\\'></i>'"></div>`
                    : `<div class="news-item-thumb" style="background: linear-gradient(135deg, rgba(249,115,22,0.15), rgba(234,88,12,0.1));"><i class="fas fa-fire" style="color:#f97316"></i></div>`;
