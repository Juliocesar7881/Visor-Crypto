// ============================================
        ...
        // Cache sistema para an�lise t�cnica
        ...
        // �"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"�
        // CALL HISTORY SYSTEM  Hist�rico real de calls
        // �"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"�
        ...
        function recordCall(symbol, signal, confidence, entryPrice, crypto, fullAnalysis) {
            ...
            // Extrair snapshot completo da an�lise para banco de dados
            const analytics = {};
            if (fullAnalysis) {
                try {
                ...
                <div style="background:linear-gradient(180deg,#1c1c35 0%,#141423 100%);border:1px solid rgba(245,158,11,0.3);border-radius:24px 24px 0 0;max-width:480px;width:100%;padding:24px 22px 36px;max-height:88vh;overflow-y:auto;box-shadow:0 -8px 40px rgba(0,0,0,0.5);animation:slideUpCard 0.3s cubic-bezier(0.22,1,0.36,1) forwards;">
                    ...
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
                        <div style="display:flex;align-items:center;gap:10px;">
                            <div style="width:36px;height:36px;background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.35);border-radius:10px;display:inline-flex;align-items:center;justify-content:center;">
                                <span style="font-size:18px;">�a�️</span>
                            </div>
                    ...
                    <div style="display:flex;flex-direction:column;gap:8px;margin-bottom:16px;">
                        <div style="display:flex;align-items:flex-start;gap:10px;padding:10px 12px;background:rgba(245,158,11,0.07);border:1px solid rgba(245,158,11,0.18);border-radius:11px;">
                            <span style="color:#f59e0b;font-size:14px;flex-shrink:0;margin-top:1px;">�x9</span>
                            <span style="font-size:12px;color:#c9d1d9;line-height:1.6;"><strong style="color:#f59e0b;">Informativo e educacional.</strong> N�o constitui aconselhamento financeiro, recomenda��o de investimento ou solicita��o de compra/venda de ativos.</span>
                        </div>
                        <div style="display:flex;align-items:flex-start;gap:10px;padding:10px 12px;background:rgba(239,68,68,0.07);border:1px solid rgba(239,68,68,0.18);border-radius:11px;">
                            <span style="color:#ef4444;font-size:14px;flex-shrink:0;margin-top:1px;">�a�</span>
                            <span style="font-size:12px;color:#c9d1d9;line-height:1.6;">Criptomoedas envolvem <strong style="color:#ef4444;">alto risco de perda total</strong> do capital. O mercado � extremamente vol�til e imprevis�vel.</span>
                        </div>
                        <div style="display:flex;align-items:flex-start;gap:10px;padding:10px 12px;background:rgba(99,102,241,0.07);border:1px solid rgba(99,102,241,0.18);border-radius:11px;">
                            <span style="color:#a78bfa;font-size:14px;flex-shrink:0;margin-top:1px;">�x�</span>
                            <span style="font-size:12px;color:#c9d1d9;line-height:1.6;">An�lises geradas por algoritmos, podendo conter erros. Resultados passados <strong style="color:#a78bfa;">n�o garantem</strong> resultados futuros.</span>
                        </div>
                        <div style="display:flex;align-items:flex-start;gap:10px;padding:10px 12px;background:rgba(88,166,255,0.07);border:1px solid rgba(88,166,255,0.18);border-radius:11px;">
                            <span style="color:#58a6ff;font-size:14px;flex-shrink:0;margin-top:1px;">�x�</span>
                            <span style="font-size:12px;color:#c9d1d9;line-height:1.6;">Fa�a sua pr�pria pesquisa (<strong style="color:#58a6ff;">DYOR</strong>) e consulte um profissional financeiro antes de investir.</span>
                        </div>
                    </div>
                    <p style="font-size:10px;color:#6e7681;line-height:1.6;text-align:center;margin-bottom:16px;">Todas as decis�es de investimento s�o de sua exclusiva responsabilidade. Os desenvolvedores n�o se responsabilizam por perdas financeiras.</p>
                    <div style="display:flex;align-items:center;justify-content:space-between;">
                        <a href="privacy-policy.html" target="_blank" style="color:#58a6ff;font-size:10px;text-decoration:underline;">Pol�tica de Privacidade</a>
        ...
        function closeTechnicalAnalysis() {
            // Fechar panel de notifica��es se aberto
            ...
            document.body.style.overflow = 'hidden'; // Manter scroll bloqueado para o modal do gr�fico
            
            // Voltar para o modal do gr�fico
            taNavigationStack.pop();
        }
        
        // Vari�vel para controlar o auto-refresh da an�lise t�cnica
...
let _taRawDataCache = {};
        ...
        async function fetchTechnicalAnalysisData(symbol) {
            ...
            const [
                ...
                fetch(`https://fapi.binance.com/fapi/v1/openInterest?symbol=${symbol}`)
                    .then(r => r.json()).catch(() => ({})),
                // Recent trades para CVD (500 �ltimos)
                ...
                fetch(`https://fapi.binance.com/futures/data/takerlongshortRatio?symbol=${symbol}&period=1h&limit=24`)
                    .then(r => r.json()).catch(() => []),
                // LIQUIDA�!�"ES FOR�!ADAS REAIS (�ltimas 100) - DADOS REAIS DA BINANCE
                fetch(`https://fapi.binance.com/fapi/v1/allForceOrders?symbol=${symbol}&limit=100`)
                    .then(r => r.json()).catch(() => []),
                // Open Interest Hist�rico (�ltimos 12 per�odos de 5min) - para OI Delta
                fetch(`https://fapi.binance.com/futures/data/openInterestHist?symbol=${symbol}&period=5m&limit=12`)
                    .then(r => r.json()).catch(() => []),
                // Liquida��es 12h do worker (em paralelo, timeout 3s)
            ...
            const result = {
                ...
                forceOrders: forceOrders || [],  // LIQUIDA�!�"ES REAIS
                openInterestHist: openInterestHist || [],  // OI Delta
                workerLiqData,  // Liquida��es 12h do worker (ou null)
        ...
        function evaluatePineV7Model(klines5m, klines15m, currentPrice) {
            ...
            // Blended Score (Pesos: 60% para 5m porque o foco � scalp e timing, 40% para 15m)
            ...
            // Se 5m e 15m cravarem compra = FORTE BUY. Se s� o 5m der compra e o score geral for bom = SCALP BUY
            ...
            if (active) {
                if (score >= 90) {
                    ...
                    confidenceBoost = 15; // Refor�ado para scalp
                } else {
        ...
        function generateTechnicalAnalysis(data, symbol) {
            ...
            // Sistema de conflu�ncia profissional com pesos
            // ============================================
            
            // RSI em m�ltiplos timeframes (peso: 2 cada)
            ...
            // ============================================
            // AN�LISE GR�FICA MULTI-TIMEFRAME (1m, 5m, 15m, 1h)
            // ============================================
            ...
            // ============================================
            // HEATMAP DE LIQUIDA�!�"ES (estilo Coinglass)
            // ============================================
            ...
            const realLiquidations = workerLiqData
                ? {
                    ...
                    dataSource: `Binance Futures (${workerLiqData.totalCount} liquida��es 12h)`,
            ...
            // EMA 200 1h (peso 1.5  dist�ncia ponderada)
            ...
            // EMA 200 4h (peso 1.5  dist�ncia ponderada)
            ...
            // ADX 1h - For�a da tend�ncia (peso 1)
            ...
            // ADX 4h (peso 1  confirma for�a da tend�ncia em timeframe maior)
            ...
            // ============================================
            // MAPA DE RISCO DE LIQUIDA�!�O PENDENTE (peso vari�vel at� 2.2)
            // ============================================
            if (liquidationRiskMap.hasData) {
                ...
                // Concentra��o de risco pr�xima ao pre�o atual acelera o efeito de conflu�ncia
                if (liquidationRiskMap.nearPct >= 30 && liquidationRiskMap.signal !== 'NEUTRO') {
                    ...
                    confluenceDetails.push({
                        name: 'Concentra��o Pr�xima',
                        value: `${liquidationRiskMap.nearPct.toFixed(0)}% em at� 3%`,
            ...
            const _srHasVolume = _srVolRatio > 1.3; // Volume acima da m�dia = confirma��o
            ...
            // ============================================
            // PINE V7 (BTC PRO) - Impacto condicional na conflu�ncia
            ...
            if (fundingRateValue > 0.05) {
                fundingSignal = 'bearish'; // Muito positivo = multid�o comprada = short
                fundingScore = -1;
                ...
                fundingSignal = 'bullish'; // Negativo = multid�o vendida = long
                fundingScore = 1;
            }
            ...
            const marketRegime = V2.detectMarketRegime ? 
                ...
                { regime: 'RANGING', regimeStrength: 0, regimeIcon: '�', regimeColor: '#f59e0b', regimeDescription: 'N/A', regimeImplication: '', isTrending: false, isRange: true };
            ...
            // ============================================
            // 1. Volume Breakout (Volume atual > 1.5x m�dia dos ultimos 20)
            ...
            if (recentVols.length >= 21) {
                ...
                if (currentVol > avgVol20 * 1.5) {
                    ...
                    if (priceDiff > 0) {
                        confluenceScore += 2;
                        confluenceDetails.push({ name: 'Volume Breakout', value: `${(currentVol/avgVol20).toFixed(1)}x m�dia`, signal: 'LONG', weight: 2, color: '#22c55e' });
                    } else if (priceDiff < 0) {
                        confluenceScore -= 2;
                        confluenceDetails.push({ name: 'Volume Breakout', value: `${(currentVol/avgVol20).toFixed(1)}x m�dia`, signal: 'SHORT', weight: 2, color: '#ef4444' });
                    }
                }
            }

            // 2. Diverg�ncia RSI x Pre�o
            const rsiValues = [];
            const closePrices = klines1h.map(k => parseFloat(k[4]));
            // Calcula��o b�sica de historico de RSI (aproximada para detec��o de diverg�ncia)
            ...
            if (klines1h.length >= 10) {
                ...
                if (currentHigh > prevHigh && rsi1h < 50) {
                    confluenceScore -= 2.5; 
                    confluenceDetails.push({ name: 'Diverg�ncia Bearish', value: 'Pre�o sobe, RSI n�o', signal: 'SHORT', weight: 2.5, color: '#ef4444' });
                }
                // bullish divergence
                ...
                if (currentLow < prevLow && rsi1h > 50) {
                    confluenceScore += 2.5;
                    confluenceDetails.push({ name: 'Diverg�ncia Bullish', value: 'Pre�o cai, RSI n�o', signal: 'LONG', weight: 2.5, color: '#22c55e' });
                }
            }
            ...
            // 4. S/R Hist�rico (estimado via repeti��o de toques)
            if (sr && sr.supportCount >= 3 && currentPrice < sr.support * 1.01 && currentPrice > sr.support * 0.99) {
                confluenceScore += 2.5;
                confluenceDetails.push({ name: 'Suporte Hist�rico', value: `>= 3 toques n�vel ${sr.support}`, signal: 'LONG', weight: 2.5, color: '#22c55e' });
            }
            if (sr && sr.resistanceCount >= 3 && currentPrice > sr.resistance * 0.99 && currentPrice < sr.resistance * 1.01) {
                confluenceScore -= 2.5;
                confluenceDetails.push({ name: 'Resist�ncia Hist�rica', value: `>= 3 toques n�vel ${sr.resistance}`, signal: 'SHORT', weight: 2.5, color: '#ef4444' });
            }
            ...
            // Probabilidade baseada em conflu�ncia contextual
            let probability = 50;
            if (totalScore > 0) {
            ...
            // Confian�a baseada em quantos indicadores concordam + regime alignment
            ...
            // Pine confidence modulation (impacta s� quando score >= 75)
            if (pineV7.active) {
        ...
        // ============================================
        // AN�LISE DE PADR�"ES GR�FICOS MULTI-TIMEFRAME
        // ============================================
        function analyzeChartPatterns(klines15m, klines1h, currentPrice) {
            ...
            // V7: Apenas timeframes estruturais (removido 1m/5m = ru�do)
            const tfData = [
            ...
            result.confluenceScore = normalizedScore * 2; // Peso 2 para conflu�ncia geral
        ...
        function analyzeTimeframe(klines, currentPrice) {
            ...
            const volTrend = recentVol > avgVol * 1.2 ? 'AUMENTANDO' : recentVol < avgVol * 0.8 ? 'DIMINUINDO' : 'EST�VEL';
            
            // ===== DETEC�!�O DE PADR�"ES DE CANDLESTICK =====
            const patterns = [];
            ...
            if (len >= 3) {
                ...
                if (fullRange > 0 && body / fullRange < 0.1) {
                    patterns.push({ name: 'Doji', icon: '�Sa', type: 'reversal', bias: 'neutro' });
                }
                // Hammer / Inverted Hammer
                if (fullRange > 0 && lowerWick > body * 2 && upperWick < body * 0.5) {
                    const isBull = c > o;
                    patterns.push({ name: 'Martelo', icon: '�x�', type: 'reversal', bias: isBull ? 'alta' : 'alta' });
                }
                ...
                if (c > o && prev_c < prev_o && c > prev_o && o < prev_c) {
                    patterns.push({ name: 'Engolfo Alta', icon: '�xx�', type: 'reversal', bias: 'alta' });
                }
                if (c < o && prev_c > prev_o && c < prev_o && o > prev_c) {
                    patterns.push({ name: 'Engolfo Baixa', icon: '�x�', type: 'reversal', bias: 'baixa' });
                }
                // Pin Bar
                if (fullRange > 0 && lowerWick / fullRange > 0.6 && body / fullRange < 0.2) {
                    patterns.push({ name: 'Pin Bar Alta', icon: '�xR', type: 'reversal', bias: 'alta' });
                }
                if (fullRange > 0 && upperWick / fullRange > 0.6 && body / fullRange < 0.2) {
                    patterns.push({ name: 'Pin Bar Baixa', icon: '�xR', type: 'reversal', bias: 'baixa' });
                }
                // Marubozu (corpo > 90% da range)
                if (fullRange > 0 && body / fullRange > 0.9) {
                    const isBull = c > o;
                    patterns.push({ name: isBull ? 'Marubozu Alta' : 'Marubozu Baixa', icon: isBull ? '�x�' : '�x�', type: 'continuation', bias: isBull ? 'alta' : 'baixa' });
                }
                // Three White Soldiers / Three Black Crows (�ltimas 3 velas)
                if (len >= 4) {
                    ...
                    if (c3[0] > o3[0] && c3[1] > o3[1] && c3[2] > o3[2] && c3[1] > c3[0] && c3[2] > c3[1]) {
                        patterns.push({ name: '3 Soldados', icon: '�xx��xx��xx�', type: 'continuation', bias: 'alta' });
                    }
                    if (c3[0] < o3[0] && c3[1] < o3[1] && c3[2] < o3[2] && c3[1] < c3[0] && c3[2] < c3[1]) {
                        patterns.push({ name: '3 Corvos', icon: '�x��x��x�', type: 'continuation', bias: 'baixa' });
                    }
                }
                ...
                if (len >= 4) {
                    ...
                    if (pp.c < pp.o && mid.body < prevBody * 0.3 && c > o && c > (pp.o + pp.c) / 2) {
                        patterns.push({ name: 'Morning Star', icon: '�xR&', type: 'reversal', bias: 'alta' });
                    }
                    if (pp.c > pp.o && mid.body < prevBody * 0.3 && c < o && c < (pp.o + pp.c) / 2) {
                        patterns.push({ name: 'Evening Star', icon: '�xR ', type: 'reversal', bias: 'baixa' });
                    }
                }
            }
            
            // Calcular sinal com mais crit�rios
            let signal = 'NEUTRO';
            let strength = 0;
        ...
        function findKeyLevels(klines, currentPrice) {
            ...
            // Filtrar n�veis pr�ximos ao pre�o atual (±10%)
        ...
        function calculateLiquidationHeatmap(currentPrice, openInterest, orderBook, takerBuySellVol) {
            ...
            // Estimar n�veis de liquida��o baseado em alavancagem t�pica
            // N�veis comuns: 2x, 3x, 5x, 10x, 20x, 25x, 50x, 100x
            const leverages = [2, 3, 5, 10, 20, 25, 50, 100];
            
            // Para LONG: liquida��o = entrada * (1 - 1/alavancagem)
            // Para SHORT: liquida��o = entrada * (1 + 1/alavancagem)
            ...
            // Calcular risco total de liquida��o
            ...
            // Analisar Taker Buy/Sell para ver press�o
        ...
        function estimateVolumeAtLevel(orderBook, targetPrice, side) {
            ...
            let volume = 0;
            const tolerance = targetPrice * 0.005; // 0.5% de toler�ncia
        ...
        // ============================================
        // DETEC�!�O DE INÍCIO DE TEND�`NCIA (REAL)
        // Identifica quando uma nova tend�ncia est� come�ando
        // ============================================
        function detectTrendStart(klines1m, klines5m, klines15m, klines1h, currentPrice) {
            ...
            if (rangeSize < 3) {
                if (currentPrice > recentHigh * 1.001) {
                    result.triggers.push({ trigger: 'Breakout de Alta (rompeu resist�ncia)', direction: 'UP', weight: 2.5 });
            ...
            // 3. VOLUME SPIKE - Volume anormal indica in�cio de movimento
            ...
            // 4. DIVERG�`NCIA RSI - Pre�o faz novo low, RSI n�o confirma
            ...
            if (rsi.length >= 10) {
                ...
                if (priceNewLow && rsiHigherLow) {
                    result.triggers.push({ trigger: 'Diverg�ncia Alta RSI (revers�o prov�vel)', direction: 'UP', weight: 2 });
                }
                ...
                if (priceNewHigh && rsiLowerHigh) {
                    result.triggers.push({ trigger: 'Diverg�ncia Baixa RSI (revers�o prov�vel)', direction: 'DOWN', weight: 2 });
                }
            }
            
            // 5. PADR�O ENGULFING (Candlestick de revers�o)
            if (klines1h.length >= 3) {
                ...
                if (prevClose < prevOpen && currClose > currOpen && 
                    ...
                    result.triggers.push({ trigger: 'Bullish Engulfing (revers�o de alta)', direction: 'UP', weight: 1.5 });
                }
                // Bearish Engulfing
                if (prevClose > prevOpen && currClose < currOpen && 
                    currOpen >= prevClose && currClose <= prevOpen) {
                    result.triggers.push({ trigger: 'Bearish Engulfing (revers�o de baixa)', direction: 'DOWN', weight: 1.5 });
                }
            }
        ...
        // ============================================
        // HEATMAP DE LIQUIDA�!�"ES  DADOS REAIS
        // Baseado em ordens for�adas (allForceOrders) da Binance
        // + agrega��o via CoinGlass public endpoints
        // Dados acumulados server-side via Cloudflare KV (compartilhado entre todos os usu�rios)
        // ============================================
        ...
        function analyzeRealLiquidations(forceOrders, currentPrice, openInterest, longShortRatio) {
            ...
            // ������ FONTE PRIM�RIA: Ordens for�adas reais da Binance ������
            ...
            if (validForceOrders.length > 0) {
                ...
                result.dataSource = `Binance (${validForceOrders.length} liquida��es)`;
                
                let longLiqVol = 0, shortLiqVol = 0;
                let longCount = 0, shortCount = 0;
                const levels = [];
                const now = Date.now();
                const recentWindow = 12 * 60 * 60 * 1000; // �ltimas 12h
                ...
                validForceOrders.forEach(order => {
                    ...
                    // side=BUY �  SHORT foi liquidado (compra for�ada p/ fechar short)
                    // side=SELL �  LONG foi liquidado (venda for�ada p/ fechar long)
                ...
                result.liquidationLevels = levels.slice(0, 20); // top 20 mais pr�ximos
        ...
        function buildLiquidationRiskMap(realLiquidations, currentPrice) {
            ...
            if (pendingLevels.length > 0) {
                ...
                // Distribui��o sint�tica quando s� temos agregados (sem n�veis por dist�ncia)
            ...
            let insight = `Maior concentra��o em ${strongestCluster.label}`;
            if (signal === 'LONG') insight += ' com mais shorts vulner�veis';
            if (signal === 'SHORT') insight += ' com mais longs vulner�veis';
            if (signal === 'NEUTRO') insight += ' e distribui��o equilibrada';
        ...
        function calculateOIChange(klines, ticker24h) {
            // Estimativa baseada em varia��o de volume
        ...
        function calculateCVD(trades) {
            ...
            trades.forEach(t => {
                ...
                const usdVol = qty * price; // usar volume em USD para precis�o
                if (t.isBuyerMaker) {
                    sellVolume += usdVol; // Maker � comprador, taker vendeu (sell market order)
                } else {
                    buyVolume += usdVol; // Maker � vendedor, taker comprou (buy market order)
                }
            });
        ...
        // Suporte e Resist�ncia baseados em Swing Highs/Lows + M�dias M�veis
        ...
        // EMA - Exponential Moving Average (seed correto via SMA dos primeiros N per�odos)
        function calculateEMA(klines, period = 200) {
            if (!klines || klines.length < period) {
                // Se n�o temos dados suficientes, usar SMA com dados dispon�veis
        ...
        function calculateNetVolume(klines) {
            ...
            klines.forEach(k => {
                ...
                // Se fechou acima da abertura, � volume de compra
                if (close > open) {
                    buyVolume += volume;
                } else if (close < open) {
                    sellVolume += volume;
        ...
        function generateLocalSummary(signalType, confidence, indicators, symbol) {
            ...
            if (indicators.movingAverages) {
                ...
                if (aboveEmas === 3 && aboveSmas >= 2) {
                    maAnalysis = '=� M�dias M�veis: FORTE tend�ncia de alta - pre�o acima de todas as EMAs e principais SMAs.';
                } else if (aboveEmas === 0 && aboveSmas <= 1) {
                    maAnalysis = '=� M�dias M�veis: FORTE tend�ncia de baixa - pre�o abaixo de todas as EMAs e principais SMAs.';
                } else if (aboveEmas >= 2) {
                    maAnalysis = '=� M�dias M�veis: Tend�ncia de curto prazo BULLISH - pre�o acima das EMAs r�pidas.';
                } else {
                    maAnalysis = '=� M�dias M�veis: Consolida��o - pre�o entre m�dias indica indecis�o.';
                }
            }
            ...
            if (indicators.whaleActivity) {
                ...
                if (whale.level === 'muito_alta' || whale.level === 'alta') {
                    if (whale.direction === 'compra') {
                        whaleAnalysis = '�x�9 Baleias: Atividade ALTA com predomin�ncia de COMPRA - institucionais acumulando.';
                    } else if (whale.direction === 'venda') {
                        whaleAnalysis = '�x�9 Baleias: Atividade ALTA com predomin�ncia de VENDA - institucionais distribuindo.';
                    } else {
                        whaleAnalysis = '�x�9 Baleias: Atividade ALTA detectada - monitorar dire��o.';
                    }
                } else if (whale.level === 'moderada') {
                    whaleAnalysis = '�x�9 Baleias: Atividade moderada no mercado.';
                }
            }
            
            // An�lise do Book Imbalance
            let bookAnalysis = '';
            if (indicators.bookImbalance) {
                const ratio = indicators.bookImbalance.ratio;
                if (ratio > 1.5) {
                    bookAnalysis = '�x Order Book: Forte press�o compradora (${ratio.toFixed(2)}x mais bids que asks).';
                } else if (ratio < 0.67) {
                    bookAnalysis = '�x" Order Book: Forte press�o vendedora (${(1/ratio).toFixed(2)}x mais asks que bids).';
                }
            }
            ...
            if (indicators.marketRegime) {
                ...
                regimeAnalysis = `<!� Regime: ${r.regimeIcon} ${r.regimeDescription}. ${r.regimeImplication}`;
                if (r.squeezeDetected) {
                    regimeAnalysis += '\n=� BOLLINGER SQUEEZE  explos�o de volatilidade iminente!';
                }
            }
            if (indicators.marketStructure) {
                const s = indicators.marketStructure;
                if (s.structureDescription) {
                    structureAnalysis = `�x� Estrutura: ${s.structureDescription}`;
                }
                if (s.liquiditySweeps?.detected) {
                    structureAnalysis += `\n�x}� ${s.liquiditySweeps.description}`;
                }
            }
            if (indicators.cvdAdvanced) {
                ...
                if (c.absorption) cvdAdvAnalysis += `�x�9 CVD: ${c.absorption.description}\n`;
                if (c.breakout) cvdAdvAnalysis += `�x� CVD: ${c.breakout.description}\n`;
            }
            ...
            if (indicators.bigTechMacro) {
                ...
                bigTechAnalysis = `�x�� Big Tech: ${bt.bigTechSentiment} (${techSummary})`;
                if (bt.fearGreed) {
                    bigTechAnalysis += `\n�x}� Fear & Greed: ${bt.fearGreed.value}/100  ${bt.fearGreed.classification}`;
                }
                if (bt.indices?.length > 0) {
                    ...
                    if (vix) bigTechAnalysis += ` | �xܱ VIX: ${vix.price.toFixed(1)}`;
                }
                if (bt.treasuryYields?.isInverted) {
                    bigTechAnalysis += '\n�a�️ CURVA DE JUROS INVERTIDA  sinal de recess�o que pressiona risk assets';
                }
            }
...
O pre�o est� ${indicators.priceLocation === 'below_value' ? 'ABAIXO da �rea de valor (barato)' : 'na regi�o inferior da �rea de valor'}. O Funding Rate ${indicators.fundingSignal === 'bullish' ? 'negativo indica que a multid�o est� vendida (oportunidade contr�ria)' : 'est� neutro'}.

O CVD mostra ${indicators.cvdSignal === 'bullish' ? 'predomin�ncia de compras agressivas a mercado' : indicators.cvdSignal === 'absorption_bullish' ? 'ABSOR�!�O de vendas por compradores (baleias acumulando)' : 'fluxo equilibrado'}.

O Order Book revela ${indicators.bookSignal === 'bid_heavy' ? 'forte suporte de bids (compradores posicionados)' : 'equil�brio entre bids e asks'}.

${maAnalysis}
${whaleAnalysis}

${indicators.rsiSignal === 'oversold' ? '�a�️ RSI em sobrevenda - momento �timo para entrada!' : ''}
${indicators.lsSignal === 'bullish' ? '�x� Long/Short Ratio indica shorts excessivos - potencial short squeeze.' : ''}

${v2Block ? '--- An�lise Detalhada ---\n' + v2Block + '\n' : ''}
Confian�a: ${confidence}%`;
            } else if (signalType === 'short') {
                return `=� SINAL SHORT DETECTADO para ${crypto}

O pre�o est� ${indicators.priceLocation === 'above_value' ? 'ACIMA da �rea de valor (caro)' : 'na regi�o superior da �rea de valor'}. O Funding Rate ${indicators.fundingSignal === 'bearish' ? 'muito positivo indica multid�o excessivamente comprada (risco de liquida��o)' : 'est� elevado'}.

O CVD mostra ${indicators.cvdSignal === 'bearish' ? 'predomin�ncia de vendas agressivas' : indicators.cvdSignal === 'absorption_bearish' ? 'ABSOR�!�O de compras por vendedores (distribui��o institucional)' : 'press�o vendedora crescente'}.

O Order Book revela ${indicators.bookSignal === 'ask_heavy' ? 'forte resist�ncia de asks (vendedores posicionados)' : 'press�o de oferta'}.

${maAnalysis}
${whaleAnalysis}

${indicators.rsiSignal === 'overbought' ? '�a�️ RSI em sobrecompra - momento �timo para short!' : ''}
${indicators.lsSignal === 'bearish' ? '�x� Long/Short Ratio indica longs excessivos - potencial long squeeze.' : ''}

${v2Block ? '--- An�lise Detalhada ---\n' + v2Block + '\n' : ''}
Confian�a: ${confidence}%`;
            } else {
                // Verificar posi��o do pre�o em rela��o ao VAH/VAL
                ...
                if (currentPrice > indicators.vah) {
                    pricePositionMsg = `O pre�o atual ($${currentPrice.toFixed(2)}) est� ACIMA da VAH ($${indicators.vah?.toFixed(2)}), mas n�o h� conflu�ncia suficiente para confirmar continua��o de alta.`;
                    recommendationMsg = `�xa� Recomenda��o: N�O OPERAR agora.
⬢ O pre�o J� rompeu VAH - aguarde reteste da VAH ($${indicators.vah?.toFixed(2)}) como SUPORTE para LONG
⬢ Ou aguarde retorno para dentro da �rea de valor para SHORT
⬢ Evite comprar no topo sem confirma��o de volume`;
                } else if (currentPrice < indicators.val) {
                    pricePositionMsg = `O pre�o atual ($${currentPrice.toFixed(2)}) est� ABAIXO da VAL ($${indicators.val?.toFixed(2)}), mas n�o h� conflu�ncia suficiente para confirmar continua��o de baixa.`;
                    recommendationMsg = `�xa� Recomenda��o: N�O OPERAR agora.
⬢ O pre�o J� rompeu VAL - aguarde reteste da VAL ($${indicators.val?.toFixed(2)}) como RESIST�`NCIA para SHORT
⬢ Ou aguarde retorno para dentro da �rea de valor para LONG
⬢ Evite vender no fundo sem confirma��o de volume`;
                } else {
                    pricePositionMsg = `O pre�o atual ($${currentPrice.toFixed(2)}) est� DENTRO da �rea de valor (VAL: $${indicators.val?.toFixed(2)} | VAH: $${indicators.vah?.toFixed(2)}).`;
                    recommendationMsg = `�xa� Recomenda��o: N�O OPERAR agora.
...
N�o h� conflu�ncia suficiente entre os indicadores para recomendar opera��o.
...
�a�️ Confian�a para opera��o: BAIXA. Sem sinal direcional.`;
            }
        }

        // �"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"�
        // GROQ AI  Relat�rio de IA real via Llama 3.3 70B
        // �"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"��"�
        ...
        // Evitar ac�mulo de mem�ria no cache de AI summaries
        function _cleanAISummaryCache() {
            const keys = Object.keys(_aiSummaryCache);
            if (keys.length > 50) {
                // Remover entradas mais antigas (manter �ltimas 20)
        ...
        async function fetchAISummary(analysis, symbol) {
            ...
            const systemPrompt = `Voc� � um analista quantitativo s�nior de criptomoedas. Gere um relat�rio t�cnico conciso em portugu�s brasileiro (PT-BR) com base nos dados fornecidos.

Regras:
- M�ximo 800 caracteres
- N�o use markdown, apenas texto limpo com emojis para se��es
- Comece com o sinal (=� LONG / =� SHORT / ⏳ NEUTRO)
- A confian�a DEVE ser EXATAMENTE ${dataPayload.confidence}%  este valor j� foi calculado pelo motor de conflu�ncia, N�O calcule nem invente outro valor
- NUNCA mencione probabilidade, apenas a Confian�a.
- Analise: regime de mercado, volume profile, order flow (CVD, funding), microestrutura, sentimento
- D� uma conclus�o objetiva: operar ou n�o, e por qu�
- Se NEUTRO, explique o que esperar para entrar
- Use linguagem direta de trader profissional
- N�O invente dados, use APENAS os fornecidos`;

            try {
                const userPrompt = `Dados da an�lise t�cnica de ${crypto} (${symbol}):\n${JSON.stringify(dataPayload)}`;
                let aiText = null;
                ...
                if (aiText) {
                    ...
                    if (realConf != null) {
                        // Replace patterns like "confian�a: 73%" or "Confian�a de 73%" or just "73% de confian�a"
                        aiText = aiText.replace(
                            /(confian[�c]a[:\s]+(?:de\s+)?)(\d{1,3})(%)/gi,
                            `$1${realConf}$3`
                        );
        ...
        async function updateAISummaryInModal(analysis, symbol) {
            ...
            if (aiResult) {
                ...
                const prefix = noKey
                    ? '��️ Relat�rio em modo local. Para IA remota via Groq, configure CALENDAR_WORKER_URL e GROQ_API_KEY no Worker.\n\n'
                    : '�a�️ IA indispon�vel  an�lise local:\n\n';
        ...
        function renderLiquidationMapSection(realLiquidations, liquidationRiskMap, formatBigNumber, formatPrice) {
            if (!realLiquidations?.hasData || !liquidationRiskMap?.hasData) {
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">Mapa de Liquida��es</div>
                    ...
                    <div style="margin-top: 12px; padding: 18px; background: var(--bg-tertiary); border-radius: 12px; text-align: center; color: var(--text-muted); font-size: 12px;">
                        Sem dados suficientes no momento. Atualiza a cada ciclo da an�lise t�cnica (5 min).
                    </div>
                </div>
                `;
            }
            ...
            const signalLabel = riskSignal === 'LONG'
                ? 'Vi�s de alta (short squeeze)'
                : riskSignal === 'SHORT'
                    ? 'Vi�s de baixa (flush de longs)'
                    : 'Sem domin�ncia clara';
            ...
            const modeLabel = liquidationRiskMap.mode === 'pending-levels'
                ? 'N�veis reais por dist�ncia do pre�o'
                : 'Distribui��o agregada por Open Interest';
            ...
            return `
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">Mapa de Liquida��es (Risco Pendente)</div>
                    ...
                    <div style="margin-top: 10px; padding: 12px; border-radius: 10px; background: var(--bg-tertiary); border: 1px solid rgba(148, 163, 184, 0.18);">
                        <div style="display: flex; justify-content: space-between; align-items: center; gap: 10px;">
                            ...
                            <div style="text-align: right;">
                                <div style="font-size: 10px; color: var(--text-muted); text-transform: uppercase;">Impacto Conflu�ncia</div>
                                <div style="font-size: 13px; font-weight: 800; color: ${signalColor};">${impactLabel}</div>
                            </div>
                        </div>
                        <div style="margin-top: 8px; font-size: 11px; color: var(--text-muted);">
                            ${liquidationRiskMap.insight || 'Sem insight adicional'} | Concentra��o em at� 3%: ${(liquidationRiskMap.nearPct || 0).toFixed(1)}%
                        </div>
                    </div>
                    ...
                    <div style="margin-top: 12px; padding: 12px; border-radius: 10px; background: var(--bg-tertiary); border: 1px solid rgba(148, 163, 184, 0.18);">
                        <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 10px; text-transform: uppercase;">
                            Escada de risco por dist�ncia (% do pre�o atual: $${formatPrice(realLiquidations.currentPrice || 0)})
                        </div>
                    ...
                    <div style="margin-top: 10px; font-size: 10px; color: var(--text-muted);">
                        Atualiza��o: ${realLiquidations.lastUpdate || '-'} | Este mapa influencia conflu�ncia, e confian�a final.
                    </div>
                </div>
            `;
        }
        ...
        function renderTechnicalAnalysis(analysis, crypto) {
            ...
            body.innerHTML = `
                ...
                <div style="display: flex; align-items: center; gap: 14px; margin-bottom: 18px; padding: 14px 16px; background: linear-gradient(135deg, var(--bg-card) 0%, var(--bg-elevated) 100%); border-radius: 16px; border: 1px solid var(--border-subtle); box-shadow: 0 2px 12px rgba(0,0,0,0.15);">
                    ...
                    <div style="padding: 6px 12px; background: rgba(99,102,241,0.12); border: 1px solid rgba(99,102,241,0.2); border-radius: 20px; font-size: 10px; font-weight: 700; color: #818cf8; letter-spacing: 0.5px; white-space: nowrap;">AN�LISE</div>
                </div>
                ...
                <div class="ta-signal-card ${signalType}">
                    <div class="ta-signal-header">
                        ...
                        <div class="ta-signal-info">
                            ...
                            ${isV4Active ? `<div style="display: flex; align-items: center; gap: 8px; margin-top: 4px; flex-wrap: wrap;">
                                ...
                                <span style="font-size: 10px; color: var(--text-muted); white-space: nowrap;">�S& ${analysis.v4GatesPassed || 0}/${analysis.v4GatesTotal || 9} confirma��es</span>
                                ${analysis.dataIntegrity && !analysis.dataIntegrity.valid ? `<span style="font-size: 9px; padding: 2px 6px; border-radius: 4px; background: rgba(239,68,68,0.2); color: #f87171; font-weight: 700;">�a�️ DADOS</span>` : ''}
                            </div>
                    ...
                    <div style="padding: 20px; background: var(--bg-tertiary); border-radius: 12px; text-align: center;">
                        <div style="font-size: 16px; font-weight: 700; color: #f59e0b; margin-bottom: 8px;">�a�️ N�O RECOMENDADO OPERAR</div>
                        <div style="font-size: 12px; color: var(--text-muted);">Conflu�ncia insuficiente. Aguarde um sinal mais claro.</div>
                ...
                <div class="ta-section" style="border: 1px solid ${analysis.btcAlignment.alignment === 'ALIGNED' ? 'rgba(34,197,94,0.3)' : analysis.btcAlignment.alignment === 'DIVERGING' ? 'rgba(239,68,68,0.3)' : 'rgba(100,116,139,0.2)'};">
                    <div class="ta-section-header">
                        ...
                        <div>
                            ...
                            <div class="ta-section-subtitle">Correla��o e dire��o relativa ao Bitcoin</div>
                        </div>
                    </div>
                    <div style="padding: 14px; background: ${analysis.btcAlignment.alignment === 'ALIGNED' ? 'rgba(34,197,94,0.06)' : analysis.btcAlignment.alignment === 'DIVERGING' ? 'rgba(239,68,68,0.06)' : 'var(--bg-tertiary)'}; border-radius: 12px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            <div>
                                <div style="font-size: 16px; font-weight: 800; color: ${analysis.btcAlignment.alignment === 'ALIGNED' ? '#22c55e' : analysis.btcAlignment.alignment === 'DIVERGING' ? '#ef4444' : '#94a3b8'};">
                                    ${analysis.btcAlignment.alignment === 'ALIGNED' ? '�S& ALINHADO' : analysis.btcAlignment.alignment === 'DIVERGING' ? '�a�️ DIVERGENTE' : '� NEUTRO'}
                                </div>
                                <div style="font-size: 11px; color: var(--text-secondary); margin-top: 2px;">${analysis.btcAlignment.description || ''}</div>
                            </div>
                            <div style="text-align: right;">
                                <div style="font-size: 9px; color: var(--text-muted); white-space: nowrap;">Correla��o</div>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px;">
                            ...
                            <div style="background: var(--bg-card); padding: 8px; border-radius: 8px; text-align: center;">
                                <div style="font-size: 9px; color: var(--text-muted); white-space: nowrap;">For�a Relativa</div>
                            ...
                            <div style="background: var(--bg-card); padding: 8px; border-radius: 8px; text-align: center;">
                                ...
                                <div style="font-size: 12px; font-weight: 700; color: ${analysis.btcAlignment.riskLevel === 'HIGH' ? '#ef4444' : analysis.btcAlignment.riskLevel === 'MEDIUM' ? '#f59e0b' : '#22c55e'};">${analysis.btcAlignment.riskLevel === 'HIGH' ? '�x� Alto' : analysis.btcAlignment.riskLevel === 'MEDIUM' ? '�xx� M�dio' : '�xx� Baixo'}</div>
                            </div>
                        </div>
                        ...
                        <div style="margin-top: 4px; font-size: 9px; color: var(--text-muted); text-align: center;">
                            Janela dominante: ${analysis.btcAlignment.dominantWindow || '48h'} | Tend�ncia corr: ${analysis.btcAlignment.corrTrend || 'STABLE'}
                        </div>
                        ` : ''}
                    </div>
                </div>
                ...
                <div class="ta-section" style="border: 1px solid rgba(139,92,246,0.2); background: linear-gradient(135deg, rgba(139,92,246,0.03) 0%, transparent 100%);">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">Diagn�stico de Mercado</div>
                            <div class="ta-section-subtitle">Percentil, Qualidade e Satura��o</div>
                        </div>
                    </div>
                    <div style="display: grid; grid-template-columns: 1fr; gap: 10px;">
                        ...
                        <div style="padding: 12px; background: var(--bg-tertiary); border-radius: 10px; border-left: 3px solid ${analysis.regimeQuality.quality === 'Acelerando' || analysis.regimeQuality.quality === 'Forte' ? '#22c55e' : analysis.regimeQuality.quality === 'Est�vel' ? '#3b82f6' : analysis.regimeQuality.quality === 'Fraco' || analysis.regimeQuality.quality === 'Enfraquecendo' ? '#f59e0b' : '#ef4444'};">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <div>
                        ...
                        <div style="padding: 12px; background: var(--bg-tertiary); border-radius: 10px; border-left: 3px solid ${(analysis.saturation.saturationPercent || 0) >= 80 ? '#ef4444' : (analysis.saturation.saturationPercent || 0) >= 50 ? '#f59e0b' : '#22c55e'};">
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                                <div>
                                    <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; text-transform: uppercase;">Satura��o / Extens�o</div>
                ...
                <div class="ta-section" style="border: 1px solid rgba(99,102,241,0.2);">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">An�lise Multi-Per�odo</div>
                ...
                <div class="ta-section" style="border: 1px solid rgba(14,165,233,0.2);">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, #0ea5e9 0%, #0284c7 100%);">
                            <span style="font-size: 18px;">�xS</span>
                        </div>
                        <div>
                            <div class="ta-section-title">Hist�rico deste Setup</div>
                            <div class="ta-section-subtitle">${analysis.setupStats.count} ocorr�ncias registradas</div>
                        </div>
                    </div>
                    <div style="padding: 14px; background: ${analysis.setupStats.quality === 'EXCELENTE' ? 'rgba(34,197,94,0.06)' : analysis.setupStats.quality === 'BOM' ? 'rgba(59,130,246,0.06)' : analysis.setupStats.quality === 'M�DIO' ? 'rgba(245,158,11,0.06)' : 'rgba(239,68,68,0.06)'}; border-radius: 12px; border: 1px solid ${analysis.setupStats.quality === 'EXCELENTE' ? 'rgba(34,197,94,0.2)' : analysis.setupStats.quality === 'BOM' ? 'rgba(59,130,246,0.2)' : analysis.setupStats.quality === 'M�DIO' ? 'rgba(245,158,11,0.2)' : 'rgba(239,68,68,0.2)'};">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                            <span style="font-size: 14px; font-weight: 800; color: ${analysis.setupStats.quality === 'EXCELENTE' ? '#22c55e' : analysis.setupStats.quality === 'BOM' ? '#3b82f6' : analysis.setupStats.quality === 'M�DIO' ? '#f59e0b' : '#ef4444'};">
                                ${analysis.setupStats.quality === 'EXCELENTE' ? '�x� ' : analysis.setupStats.quality === 'BOM' ? '�x�' : analysis.setupStats.quality === 'M�DIO' ? '�x�' : '�a�️'} ${analysis.setupStats.quality}
                            </span>
                            <span style="font-size: 10px; color: var(--text-muted);">${analysis.setupStats.count} ocorr�ncias</span>
                        </div>
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px;">
                        ...
                        <div style="margin-top: 8px; padding: 6px 10px; background: rgba(245,158,11,0.1); border-radius: 6px; font-size: 10px; color: #f59e0b; text-align: center;">
                            �a�️ Amostra pequena  dados estatisticamente insuficientes
                        </div>
                        ` : ''}
                    </div>
                </div>
                ...
                <div class="ta-section" style="border: 1px solid ${analysis.marketBreadth.alignment === 'STRONG_ALIGNED' ? 'rgba(34,197,94,0.3)' : analysis.marketBreadth.alignment === 'DIVERGING' ? 'rgba(239,68,68,0.3)' : 'rgba(100,116,139,0.2)'};">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, #06b6d4 0%, #0891b2 100%);">
                            <span style="font-size: 18px;">�xR�</span>
                        </div>
                        <div>
                            <div class="ta-section-title">Sentimento do Mercado</div>
                            <div class="ta-section-subtitle">An�lise geral do mercado  ${analysis.marketBreadth.totalAssets} ativos analisados</div>
                        </div>
                    </div>
                    <div style="padding: 14px; border-radius: 12px; background: var(--bg-tertiary);">
                        ...
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            <span style="font-size: 11px; color: #22c55e; font-weight: 700;">�xx� Long ${analysis.marketBreadth.longPct}%</span>
                            <span style="font-size: 11px; color: #64748b; font-weight: 600;">Neutro ${analysis.marketBreadth.neutralPct}%</span>
                            <span style="font-size: 11px; color: #ef4444; font-weight: 700;">�x� Short ${analysis.marketBreadth.shortPct}%</span>
                        </div>
                    ...
                    <div style="padding: 14px; background: var(--bg-tertiary); border-radius: 12px;">
                        ...
                        <div style="margin-bottom: 10px;">
                            ...
                            <div style="display: flex; justify-content: space-between; margin-top: 4px; font-size: 9px; color: var(--text-muted);">
                                <span>0</span>
                                <span style="color: ${indicators.pineV7.score >= 90 ? '#22c55e' : indicators.pineV7.score >= 75 ? '#f59e0b' : '#94a3b8'}; font-weight: 700;">${indicators.pineV7.score >= 90 ? '�xx� Alta Assertividade' : indicators.pineV7.score >= 75 ? '�xx� Assertividade Moderada' : '� Sem Setup'}</span>
                                <span>100</span>
                            </div>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 6px; margin-bottom: 10px;">
                            ...
                            <div style="background: var(--bg-card); padding: 8px; border-radius: 8px; text-align: center;">
                                <div style="font-size: 8px; color: var(--text-muted); text-transform: uppercase; font-weight: 700;">Conflu�ncia</div>
                        ...
                        <div style="display: flex; gap: 4px; flex-wrap: wrap;">
                            ...
                            <span style="font-size: 10px; padding: 3px 8px; border-radius: 6px; background: ${indicators.pineV7.components.forca ? 'rgba(59,130,246,0.15)' : 'rgba(148,163,184,0.1)'}; color: ${indicators.pineV7.components.forca ? '#60a5fa' : 'var(--text-muted)'};">
                                ${indicators.pineV7.components.forca ? '�x� For�a (ADX>' : '=4 Fraco (ADX<'}20)
                            </span>
                            <span style="font-size: 10px; padding: 3px 8px; border-radius: 6px; background: ${(indicators.pineV7.components.pullbackCompra || indicators.pineV7.components.pullbackVenda) ? 'rgba(168,85,247,0.15)' : 'rgba(148,163,184,0.1)'}; color: ${(indicators.pineV7.components.pullbackCompra || indicators.pineV7.components.pullbackVenda) ? '#c084fc' : 'var(--text-muted)'};">
                                ${(indicators.pineV7.components.pullbackCompra || indicators.pineV7.components.pullbackVenda) ? ' No Pullback' : '�S Longe das EMAs'}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            ...
                            <div class="ta-section-subtitle">Classifica��o baseada em ADX + Volume + Bollinger</div>
                        </div>
                    </div>
                    <div style="padding: 16px; background: linear-gradient(135deg, ${marketRegime.regimeColor}15 0%, transparent 100%); border-radius: 12px; border: 1px solid ${marketRegime.regimeColor}30;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            ...
                            <div style="text-align: right;">
                                <div style="font-size: 10px; color: var(--text-muted);">For�a</div>
                        ...
                        <div style="padding: 10px; background: rgba(139, 92, 246, 0.15); border: 1px solid rgba(139, 92, 246, 0.3); border-radius: 8px; margin-bottom: 8px;">
                            ...
                            <div style="font-size: 10px; color: var(--text-muted); margin-top: 2px;">Volatilidade comprimida  explos�o de pre�o iminente</div>
                        </div>
                        ` : ''}
                        <div style="padding: 10px; background: var(--bg-tertiary); border-radius: 8px;">
                            <div style="font-size: 11px; color: var(--text-muted);">�x� Implica��o:</div>
                    ...
                    <div style="padding: 16px; background: var(--bg-tertiary); border-radius: 12px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            <div style="font-size: 16px; font-weight: 800; white-space: nowrap; color: ${marketStructure.overallStructure === 'BULLISH' ? '#22c55e' : marketStructure.overallStructure === 'BEARISH' ? '#ef4444' : '#94a3b8'};">
                                ${marketStructure.overallStructure === 'BULLISH' ? '��' : marketStructure.overallStructure === 'BEARISH' ? '�' : '�'} ${marketStructure.overallStructure}
                            </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">CVD Avan�ado</div>
                            <div class="ta-section-subtitle">Diverg�ncias, Absor��o, Breakouts</div>
                        </div>
                    </div>
                    <div style="padding: 16px; background: var(--bg-tertiary); border-radius: 12px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px;">
                            <div style="padding: 8px; background: ${cvdAdvanced.divergence ? (cvdAdvanced.divergence.type.includes('BULLISH') ? 'rgba(34,197,94,0.15)' : 'rgba(239,68,68,0.15)') : 'var(--bg-card)'}; border-radius: 8px; text-align: center;">
                                <div style="font-size: 9px; color: var(--text-muted); white-space: nowrap;">Diverg�ncia</div>
                            ...
                            <div style="padding: 8px; background: ${cvdAdvanced.absorption ? 'rgba(139,92,246,0.15)' : 'var(--bg-card)'}; border-radius: 8px; text-align: center;">
                                <div style="font-size: 9px; color: var(--text-muted); white-space: nowrap;">Absor��o</div>
                                <div style="font-size: 14px;">${cvdAdvanced.absorption ? '�x�9' : ''}</div>
                            ...
                            <div style="padding: 8px; background: ${cvdAdvanced.breakout ? 'rgba(249,115,22,0.15)' : 'var(--bg-card)'}; border-radius: 8px; text-align: center;">
                                ...
                                <div style="font-size: 14px;">${cvdAdvanced.breakout ? '�x�' : ''}</div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">Not�cias Urgentes</div>
                            <div class="ta-section-subtitle">Alertas de alto impacto e not�cias relevantes</div>
                        </div>
                    </div>
                    <div style="padding: 16px; background: var(--bg-tertiary); border-radius: 12px;">
                        <!-- Macro Sentiment -->
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            <div>
                                <div style="font-size: 14px; font-weight: 700; color: ${macroNews.macroColor}; white-space: nowrap;">
                                    ${macroNews.macroSentiment === 'BULLISH' ? '�xx�' : macroNews.macroSentiment === 'BEARISH' ? '�x�' : macroNews.macroSentiment === 'CAUTELA' ? '�xx�' : '�'} 
                        ...
                        <div style="margin-bottom: 12px;">
                            <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 8px; text-transform: uppercase;">�x& Pr�ximos Eventos de Alto Impacto</div>
                        ...
                        <div>
                            <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 8px; text-transform: uppercase;">�x� Not�cias de Alto Impacto</div>
                            ...
                            <div style="padding: 8px; background: var(--bg-card); border-radius: 6px; margin-bottom: 4px; border-left: 3px solid ${n.sentiment > 0 ? '#22c55e' : n.sentiment < 0 ? '#ef4444' : '#94a3b8'};">
                                <div style="font-size: 11px; color: var(--text-primary); line-height: 1.3;">${n.isUrgent ? '�xa� ' : ''}${n.title?.substring(0, 80)}</div>
                                <div style="font-size: 9px; color: var(--text-muted); margin-top: 4px;">${n.source} ⬢ ${n.sentiment > 0 ? '�xx� Bullish' : n.sentiment < 0 ? '�x� Bearish' : '� Neutro'}</div>
                            </div>
                            `).join('')}
                        </div>
                        ` : `
                        <div style="text-align: center; padding: 12px; color: var(--text-muted); font-size: 11px;">
                            �S& Nenhuma not�cia urgente detectada
                        </div>
                        `}
                    </div>
                </div>
                ...
                <div class="ta-section">
                    ...
                    <div style="padding: 12px; background: var(--bg-tertiary); border-radius: 12px; overflow: hidden;">
                        ...
                        <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 10px; text-transform: uppercase;">�x�� Big Tech  Resultados em Tempo Real</div>
                        ...
                        <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 10px; text-transform: uppercase;">�x}� Fear & Greed Index</div>
                        ...
                        <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 10px; text-transform: uppercase;">�x�:️ Treasury Yields (T�tulos do Tesouro EUA)</div>
                        ...
                        <div style="padding: 8px 12px; background: rgba(239,68,68,0.12); border: 1px solid rgba(239,68,68,0.25); border-radius: 8px; margin-bottom: 16px;">
                            <div style="font-size: 11px; font-weight: 700; color: #ef4444;">�a�️ Curva de Juros INVERTIDA (3M-10Y: ${bigTechMacro.treasuryYields.yieldCurveSpread?.toFixed(2) || '?'}%)  Sinal de recess�o</div>
                        </div>
                        ` : `
                        <div style="padding: 8px 12px; background: rgba(34,197,94,0.08); border-radius: 8px; margin-bottom: 16px;">
                            <div style="font-size: 11px; color: var(--text-muted);">�S& Spread 3M-10Y: ${bigTechMacro.treasuryYields.yieldCurveSpread != null ? bigTechMacro.treasuryYields.yieldCurveSpread.toFixed(2) + '%' : 'N/A'}  Curva normal</div>
                        </div>
                        `}
                        ` : ''}
                        ...
                        <div style="font-size: 11px; color: var(--text-muted); font-weight: 700; margin-bottom: 10px; text-transform: uppercase;">�x!��x!� Indicadores Macroeconômicos dos EUA</div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            ...
                            <div class="ta-section-subtitle">Fluxo de ordens e inten��o institucional</div>
                        </div>
                    </div>
                    ...
                    <div style="background: var(--bg-tertiary); border-radius: 12px; padding: 16px; margin-bottom: 16px;">
                        ...
                        <div style="margin-top: 12px; padding: 10px; background: ${parseFloat(indicators.orderFlow.fundingRate) > 0.03 ? 'rgba(239, 68, 68, 0.15)' : parseFloat(indicators.orderFlow.fundingRate) < -0.01 ? 'rgba(34, 197, 94, 0.15)' : 'rgba(245, 158, 11, 0.15)'}; border-radius: 8px;">
                            <div style="font-size: 11px; font-weight: 600; color: ${parseFloat(indicators.orderFlow.fundingRate) > 0.03 ? '#ef4444' : parseFloat(indicators.orderFlow.fundingRate) < -0.01 ? '#22c55e' : '#f59e0b'};">
                                ${parseFloat(indicators.orderFlow.fundingRate) > 0.05 ? '�a�️ MUITO ALTO - Mercado sobrecomprado, press�o de venda iminente' : parseFloat(indicators.orderFlow.fundingRate) > 0.03 ? '�� ALTO - Longs dominantes, risco de liquida��o cascata' : parseFloat(indicators.orderFlow.fundingRate) > 0.01 ? '=� LEVEMENTE ALTO - Longs pagando shorts' : parseFloat(indicators.orderFlow.fundingRate) < -0.03 ? '�a�️ MUITO NEGATIVO - Shorts dominantes, poss�vel squeeze' : parseFloat(indicators.orderFlow.fundingRate) < -0.01 ? '� NEGATIVO - Shorts pagando longs' : '� NEUTRO - Mercado equilibrado'}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ta-indicator-grid">
                        <div class="ta-indicator-item">
                            ...
                            <div class="ta-indicator-change">${indicators.orderFlow.cvdSignal.includes('absorption') ? '�a� Absor��o detectada' : 'Delta de volume'}</div>
                        </div>
                        <div class="ta-indicator-item">
                            <div class="ta-indicator-header">
                                ...
                                <span class="ta-indicator-signal ${indicators.orderFlow.oiSignal === 'increasing' ? 'bullish' : indicators.orderFlow.oiSignal === 'decreasing' ? 'bearish' : 'neutral'}">
                                    ${indicators.orderFlow.oiSignal === 'increasing' ? 'SUBINDO' : indicators.orderFlow.oiSignal === 'decreasing' ? 'CAINDO' : 'EST�VEL'}
                                </span>
                            </div>
                            <div class="ta-indicator-value">${indicators.orderFlow.oiChange > 0 ? '+' : ''}${indicators.orderFlow.oiChange}%</div>
                            <div class="ta-indicator-change">Varia��o de contratos</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            ...
                            <div class="ta-section-subtitle">Mapa de pre�o justo (Auction Market Theory)</div>
                        </div>
                    </div>
                    <div class="ta-indicator-grid">
                        <div class="ta-indicator-item">
                        ...
                        <div class="ta-indicator-item">
                            ...
                            <div class="ta-indicator-change">M�dia institucional</div>
                        </div>
                        <div class="ta-indicator-item">
                            <div class="ta-indicator-header">
                            ...
                            <div class="ta-indicator-change">�rea de valor alta</div>
                        </div>
                        <div class="ta-indicator-item">
                            <div class="ta-indicator-header">
                            ...
                            <div class="ta-indicator-change">�rea de valor baixa</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            ...
                            <div class="ta-section-subtitle">Filtros de conflu�ncia t�cnica</div>
                        </div>
                    </div>
                    <div class="ta-indicator-grid">
                        <div class="ta-indicator-item">
                            ...
                            <div class="ta-indicator-change">${parseFloat(indicators.sentiment.rsi) < 30 ? '�a� Oportunidade' : parseFloat(indicators.sentiment.rsi) > 70 ? '�a�️ Cuidado' : 'Normal'}</div>
                        </div>
                        <div class="ta-indicator-item">
                            <div class="ta-indicator-header">
                            ...
                            <div class="ta-indicator-change">${parseFloat(indicators.sentiment.takerRatio) > 1 ? '�xx� Press�o compradora' : parseFloat(indicators.sentiment.takerRatio) < 1 ? '�x� Press�o vendedora' : 'Equilibrado'}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">M�dias M�veis</div>
                    ...
                    <div style="margin-top: 12px; padding: 12px; background: var(--bg-tertiary); border-radius: 10px;">
                        <div style="font-size: 11px; font-weight: 700; color: var(--accent-purple); margin-bottom: 8px;">
                            <i class="fas fa-layer-group" style="margin-right: 6px;"></i>Suporte & Resist�ncia
                        </div>
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                            ...
                            <div style="background: var(--bg-card); padding: 10px; border-radius: 8px; border-left: 3px solid #ef4444;">
                                <div style="font-size: 10px; color: var(--text-muted);">RESIST�`NCIA</div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">Alertas & Limita��es</div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, #ef4444 0%, #991b1b 100%);">
                            <span style="font-size: 18px;">${analysis.crashState.override.icon || '�xa�'}</span>
                        </div>
                        <div>
                            <div class="ta-section-title">Detector de Crash/Pump</div>
                            <div class="ta-section-subtitle">Prote��o contra Black Swan</div>
                        </div>
                    </div>
                    <div style="padding: 16px; background: ${analysis.crashState.isCrash || analysis.crashState.isRapidPump ? 'rgba(239,68,68,0.1)' : 'rgba(234,179,8,0.1)'}; border-radius: 12px; border: 1px solid ${analysis.crashState.isCrash || analysis.crashState.isRapidPump ? 'rgba(239,68,68,0.3)' : 'rgba(234,179,8,0.3)'};">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                            ...
                            <span style="font-size: 11px; white-space: nowrap; color: var(--text-muted);">Dire��o: ${analysis.crashState.direction === 'down' ? '�  Queda' : '�  Alta'}</span>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 8px;">
                            ...
                            <div style="background: var(--bg-tertiary); padding: 8px; border-radius: 8px; text-align: center;">
                                ...
                                <div style="font-size: 13px; font-weight: 700; color: ${analysis.crashState.volumeSpikeDetected ? '#ef4444' : '#94a3b8'};">${analysis.crashState.volumeSpikeDetected ? 'SIM' : 'N�O'}</div>
                            </div>
                        </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">Gest�o de Risco & Posi��o</div>
                            <div class="ta-section-subtitle">Quanto arriscar nesta opera��o</div>
                        </div>
                    </div>
                    <div style="padding: 16px; background: rgba(14,165,233,0.08); border-radius: 12px; border: 1px solid rgba(14,165,233,0.2);">
                        ...
                        <div style="text-align: center; margin-bottom: 14px;">
                            ...
                            <div style="display: inline-block; margin-top: 8px; padding: 4px 12px; border-radius: 8px; background: ${analysis.positionSize.riskLevel === 'CONSERVADOR' ? 'rgba(34,197,94,0.2)' : analysis.positionSize.riskLevel === 'MODERADO' ? 'rgba(234,179,8,0.2)' : 'rgba(239,68,68,0.2)'}; color: ${analysis.positionSize.riskLevel === 'CONSERVADOR' ? '#22c55e' : analysis.positionSize.riskLevel === 'MODERADO' ? '#eab308' : '#ef4444'}; font-size: 10px; font-weight: 700;">
                                ${analysis.positionSize.riskLevel === 'CONSERVADOR' ? '�x:�️ Risco Baixo' : analysis.positionSize.riskLevel === 'MODERADO' ? '� Risco M�dio' : analysis.positionSize.riskLevel === 'AGRESSIVO' ? '�x� Risco Alto' : '�a�️ Risco M�ximo'}
                            </div>
                        </div>
                        <!-- Explica��o simples -->
                        <div style="display: flex; flex-direction: column; gap: 6px;">
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px; background: var(--bg-tertiary); border-radius: 8px;">
                                <span style="font-size: 11px; color: var(--text-muted);">=� Confian�a do sinal</span>
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px; background: var(--bg-tertiary); border-radius: 8px;">
                                <span style="font-size: 11px; color: var(--text-muted);"><!� Volatilidade (ATR)</span>
                            ...
                            <div style="padding: 10px; background: rgba(239,68,68,0.1); border-radius: 8px; border: 1px solid rgba(239,68,68,0.2);">
                                <span style="font-size: 11px; color: #ef4444; font-weight: 600;">�a�️ Mercado em queda detectado  posi��o reduzida automaticamente</span>
                            </div>
                            ` : ''}
                        </div>
                        <div style="margin-top: 10px; padding: 10px; background: rgba(14,165,233,0.06); border-radius: 8px; border: 1px dashed rgba(14,165,233,0.2);">
                            <div style="font-size: 10px; color: var(--text-muted); text-align: center; line-height: 1.5;">
                                �x� <strong>Dica:</strong> Se voc� tem R$ 1.000, use no m�ximo R$ ${(10 * analysis.positionSize.sizePercent).toFixed(0)} nesta opera��o.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">An�lise On-Chain</div>
                ...
                <div class="ta-section" style="border: 1px solid rgba(249,115,22,0.3); background: linear-gradient(135deg, rgba(249,115,22,0.05) 0%, transparent 100%);">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">Confirma��es</div>
                            <div class="ta-section-subtitle">Reagir ao mercado, n�o antecipar  ${analysis.v4GatesPassed || 0}/${analysis.v4GatesTotal || 9} confirma��es</div>
                        </div>
                    </div>
                    <div style="margin-bottom: 10px; padding: 10px; border-radius: 8px; background: rgba(249,115,22,0.08); border: 1px solid rgba(249,115,22,0.15);">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                            <span style="font-size: 12px; font-weight: 700; color: #fb923c; white-space: nowrap;">Score de Confirma��o</span>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 6px;">
                        ${analysis.v4Gates.map(g => `
                            <div style="display: flex; align-items: flex-start; gap: 8px; padding: 8px 10px; background: ${g.passed ? 'rgba(34,197,94,0.06)' : 'rgba(239,68,68,0.06)'}; border-radius: 8px; border-left: 3px solid ${g.passed ? '#22c55e' : '#ef4444'};">
                                <span style="font-size: 14px; min-width: 20px;">${g.passed ? '�S&' : '�R'}</span>
                                <div style="flex: 1;">
                                    <div style="font-size: 11px; font-weight: 700; color: var(--text-primary); white-space: nowrap;">${g.name}</div>
                                    <div style="font-size: 10px; color: var(--text-secondary); margin-top: 2px; line-height: 1.3;">${(g.description || '').replace(/^[�S&�R�a�️]\s?/, '')}</div>
                                </div>
                            </div>
                        `).join('')}
                    </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">For�a do Movimento</div>
                            <div class="ta-section-subtitle">Intensidade e volume do �ltimo movimento</div>
                        </div>
                    </div>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-bottom: 8px;">
                        ...
                        <div style="padding: 10px; background: ${analysis.volumeExpansion?.expanding ? 'rgba(34,197,94,0.1)' : 'rgba(100,116,139,0.1)'}; border-radius: 8px; border: 1px solid ${analysis.volumeExpansion?.expanding ? 'rgba(34,197,94,0.2)' : 'rgba(100,116,139,0.15)'};">
                            ...
                            <div style="font-size: 10px; color: var(--text-secondary); margin-top: 2px;">Intensidade: ${analysis.volumeExpansion?.volZScore != null ? analysis.volumeExpansion.volZScore.toFixed(2) : (analysis.volumeExpansion?.['1h']?.ratio || '?') + '� m�dia'}${analysis.volumeExpansion?.sustained ? ' (sustentado)' : ''}</div>
                        </div>
                    </div>
                ...
                <div class="ta-section">
                    <div class="ta-section-header">
                        ...
                        <div>
                            <div class="ta-section-title">Posi��o no Range</div>
                            <div class="ta-section-subtitle">An�lise de posi��o relativa do pre�o</div>
                        </div>
                    </div>
                    <div style="padding: 12px; background: ${analysis.rangePosition.tradeable ? 'rgba(34,197,94,0.08)' : 'rgba(239,68,68,0.08)'}; border-radius: 10px; border: 1px solid ${analysis.rangePosition.tradeable ? 'rgba(34,197,94,0.2)' : 'rgba(239,68,68,0.2)'}; margin-bottom: 8px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
                            ...
                            <span style="font-size: 10px; padding: 3px 8px; border-radius: 4px; font-weight: 700; white-space: nowrap; background: ${analysis.rangePosition.tradeable ? 'rgba(34,197,94,0.2)' : 'rgba(239,68,68,0.2)'}; color: ${analysis.rangePosition.tradeable ? '#22c55e' : '#ef4444'};">${analysis.rangePosition.tradeable ? 'OPER�VEL' : 'BLOQUEADO'}</span>
                        </div>
                    ...
                    <div style="padding: 8px 10px; background: rgba(34,197,94,0.1); border-radius: 8px; margin-top: 6px; border: 1px solid rgba(34,197,94,0.2);">
                        <div style="font-size: 11px; font-weight: 700; color: #22c55e;">�S& ${analysis.retest.details}</div>
                ...
                <div class="ta-section" style="border: 1px solid ${analysis.sessionContext.session === 'KILL_ZONE' ? 'rgba(239,68,68,0.3)' : analysis.sessionContext.session === 'LONDON_OPEN' ? 'rgba(59,130,246,0.3)' : 'rgba(100,116,139,0.2)'}; background: linear-gradient(135deg, ${analysis.sessionContext.session === 'KILL_ZONE' ? 'rgba(239,68,68,0.05)' : analysis.sessionContext.session === 'LONDON_OPEN' ? 'rgba(59,130,246,0.05)' : 'rgba(100,116,139,0.03)'} 0%, transparent 100%);">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, ${analysis.sessionContext.session === 'KILL_ZONE' ? '#ef4444, #dc2626' : analysis.sessionContext.session === 'LONDON_OPEN' ? '#3b82f6, #2563eb' : '#64748b, #475569'});">
                            <span style="font-size: 18px;">${analysis.sessionContext.session === 'KILL_ZONE' ? '�x�' : analysis.sessionContext.session === 'LONDON_OPEN' ? '�x!��x!�' : analysis.sessionContext.session === 'ASIAN' ? '�xR�' : analysis.sessionContext.isWeekend ? '�xa�' : '�x"�'}</span>
                        </div>
                        <div>
                            <div class="ta-section-title">Sess�o: ${analysis.sessionContext.session === 'KILL_ZONE' ? 'Zona de Volatilidade' : analysis.sessionContext.session === 'LONDON_OPEN' ? 'Abertura Londres' : analysis.sessionContext.session === 'ASIAN' ? 'Sess�o Asi�tica' : analysis.sessionContext.session === 'NY_OPEN' ? 'Abertura Nova York' : analysis.sessionContext.session || 'N/A'}</div>
                            <div class="ta-section-subtitle">${analysis.sessionContext.description || 'Contexto de sess�o'}</div>
                        </div>
                    </div>
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px;">
                        ...
                        <div style="padding: 8px; background: var(--bg-primary); border-radius: 8px; text-align: center;">
                            ...
                            <div style="font-size: 12px; font-weight: 700; color: ${analysis.sessionContext.liquidityLevel === 'ALTA' || analysis.sessionContext.liquidityLevel === 'M�XIMA' ? '#22c55e' : analysis.sessionContext.liquidityLevel === 'BAIXA' ? '#ef4444' : '#f59e0b'}; white-space: nowrap;">${analysis.sessionContext.liquidityLevel || 'N/A'}</div>
                        </div>
                        <div style="padding: 8px; background: var(--bg-primary); border-radius: 8px; text-align: center;">
                            <div style="font-size: 9px; color: var(--text-muted); white-space: nowrap;">Fake Breakout</div>
                            <div style="font-size: 12px; font-weight: 700; color: ${analysis.sessionContext.fakeBreakoutRisk === 'ALTO' ? '#ef4444' : analysis.sessionContext.fakeBreakoutRisk === 'M�DIO' ? '#f59e0b' : '#22c55e'}; white-space: nowrap;">${analysis.sessionContext.fakeBreakoutRisk || 'N/A'}</div>
                        </div>
                    </div>
                    ...
                    <div style="margin-top: 8px; padding: 8px 10px; background: rgba(239,68,68,0.1); border-radius: 8px; border: 1px solid rgba(239,68,68,0.2);">
                        <div style="font-size: 11px; font-weight: 700; color: #f87171;">�xa� FIM DE SEMANA  Todos sinais limitados a AGUARDAR</div>
                    </div>
                    ` : ''}
                </div>
                ` : ''}
                ...
                <div class="ta-section" style="border: 1px solid rgba(168,85,247,0.3); background: linear-gradient(135deg, rgba(168,85,247,0.05) 0%, transparent 100%);">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, #a855f7 0%, #7c3aed 100%);">
                            <span style="font-size: 18px;">�x9</span>
                        </div>
                        <div>
                            <div class="ta-section-title">Plano de Execu��o</div>
                ...
                <div class="ta-section" style="border: 1px solid ${analysis.riskEngine.killSwitchActive ? 'rgba(239,68,68,0.4)' : 'rgba(245,158,11,0.2)'}; background: ${analysis.riskEngine.killSwitchActive ? 'linear-gradient(135deg, rgba(239,68,68,0.08) 0%, transparent 100%)' : 'none'};">
                    <div class="ta-section-header">
                        <div class="ta-section-icon" style="background: linear-gradient(135deg, ${analysis.riskEngine.killSwitchActive ? '#ef4444, #dc2626' : '#f59e0b, #d97706'});">
                            <span style="font-size: 18px;">${analysis.riskEngine.killSwitchActive ? '�x:' : '�x:�️'}</span>
                        </div>
                        <div>
                            <div class="ta-section-title">Gest�o de Risco</div>
                            <div class="ta-section-subtitle">${analysis.riskEngine.killSwitchActive ? '�a�️ Kill Switch ATIVO  ' + (analysis.riskEngine.killSwitchReason || 'pausa for�ada') : 'Gest�o din�mica de risco'}</div>
                        </div>
                    </div>
                    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; min-width: 0;">
                        ...
                        <div style="padding: 8px; background: var(--bg-primary); border-radius: 8px; text-align: center; min-width: 0;">
                            ...
                            <div style="font-size: 12px; font-weight: 700; color: ${analysis.riskEngine.riskLevel === 'LOW' ? '#22c55e' : analysis.riskEngine.riskLevel === 'MEDIUM' ? '#f59e0b' : '#ef4444'};">${analysis.riskEngine.riskLevel === 'LOW' ? 'Baixo' : analysis.riskEngine.riskLevel === 'MEDIUM' ? 'M�dio' : analysis.riskEngine.riskLevel === 'HIGH' ? 'Alto' : 'N/A'}</div>
                        </div>
                    </div>
                    <div style="margin-top: 8px; display: flex; gap: 8px; min-width: 0;">
                        <div style="flex: 1; padding: 6px 10px; background: var(--bg-tertiary); border-radius: 6px; min-width: 0;">
                            <div style="font-size: 9px; color: var(--text-muted);">DD Di�rio</div>
                ...
                <div class="ta-section" style="border: 1px solid rgba(100,116,139,0.15);">
                    ...
                    <div style="margin-top: 8px; padding: 8px 10px; background: rgba(239,68,68,0.06); border-radius: 8px; font-size: 11px; color: var(--text-secondary);">
                        �x� Liquida��es (1h): <strong>${analysis.oiAnalysis.liquidations.longs} longs</strong> / <strong>${analysis.oiAnalysis.liquidations.shorts} shorts</strong>  Total: <strong>$${(analysis.oiAnalysis.liquidations.totalUSD / 1000).toFixed(0)}K</strong>
                    </div>` : ''}
                </div>
                ...
                <div class="ta-ai-summary">
                    <div class="ta-ai-header">
                        ...
                        <div class="ta-ai-title">Relat�rio da IA <span style="font-size: 9px; color: var(--text-muted); font-weight: 400;">Llama 3.3 70B via Groq</span></div>
                    </div>
                    <div class="ta-ai-text" style="white-space: pre-line;"><span style="color: var(--accent-blue);"><i class="fas fa-spinner fa-spin"></i> Gerando relat�rio com IA (Llama 3.3 70B)...</span></div>
                </div>
                
                <!-- �a�️ AVISO LEGAL - Bot�o que abre modal -->
                ...
                <div class="ta-last-update">
                    ...
                    <span>�altima atualiza��o: ${new Date(timestamp).toLocaleTimeString('pt-BR')}</span>
