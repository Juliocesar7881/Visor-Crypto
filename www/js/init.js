        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            setTimeout(() => {
                const startupTasks = [
                    ...
                    { delay: 4200, fn: () => { if (typeof window.fetchMarketIndicators === 'function') window.fetchMarketIndicators(); } }
                ];
            ...
            const _autoRefreshConfigs = [
                ...
                { fn: fetchOrderBook, ms: 15000, label: 'orderbook' },
                ...
                { fn: () => { if (typeof window.fetchMarketIndicators === 'function') window.fetchMarketIndicators(); }, ms: 300000, label: 'macro' },
            ];
