        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // AI update every 2s
            setInterval(() => { try { updateAIRecommendation(); } catch(e) {} }, 2000);
            ...
            function _startAllAutoRefresh() {
                _stopAllAutoRefresh();
                window._autoRefreshIds = _autoRefreshConfigs.map(c => setInterval(() => { try { c.fn(); } catch(e) { console.error('[AutoRefresh]', c.label, e); } }, c.ms));
